...
public final class Http1Codec implements HttpCodec {
    ...
    public void writeRequest(Headers headers, String requestLine) throws IOException {
        ...
        this.sink.writeUtf8(requestLine).writeUtf8(HttpProxyConstants.CRLF);
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.writeUtf8(headers.name(i)).writeUtf8(": ").writeUtf8(headers.value(i)).writeUtf8(HttpProxyConstants.CRLF);
        }
        this.sink.writeUtf8(HttpProxyConstants.CRLF);
        this.state = 1;
    }
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            if (byteCount != 0) {
                ...
                Http1Codec.this.sink.writeUtf8(HttpProxyConstants.CRLF);
                Http1Codec.this.sink.write(source, byteCount);
                Http1Codec.this.sink.writeUtf8(HttpProxyConstants.CRLF);
            }
        }
