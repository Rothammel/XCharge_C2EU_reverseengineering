    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (body != null) {
            ...
            if (contentLength != -1) {
                ...
                requestBuilder.header(org.apache.http.HttpHeaders.TRANSFER_ENCODING, "chunked");
        ...
        if (userRequest.header(org.apache.http.HttpHeaders.CONNECTION) == null) {
            requestBuilder.header(org.apache.http.HttpHeaders.CONNECTION, "Keep-Alive");
        }
        boolean transparentGzip = false;
        if (userRequest.header(org.apache.http.HttpHeaders.ACCEPT_ENCODING) == null && userRequest.header("Range") == null) {
