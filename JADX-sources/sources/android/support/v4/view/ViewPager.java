    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                int widthSpec2 = View.MeasureSpec.makeMeasureSpec((int) (childWidthSize * lp.widthFactor), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childWidth * lp2.widthFactor), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                        int heightSpec = View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
