                    ...
                    if (child2.getVisibility() != 8) {
                        ...
                        if (canSlide && child2 != this.mSlideableView) {
                            if (lp2.width < 0 && (measuredWidth > fixedPanelWidthLimit || lp2.weight > 0.0f)) {
                                ...
                                int childWidthSpec2 = View.MeasureSpec.makeMeasureSpec(fixedPanelWidthLimit, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                            ...
                            if (canSlide) {
                                ...
                                int childWidthSpec3 = View.MeasureSpec.makeMeasureSpec(newWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                                ...
                                int childWidthSpec4 = View.MeasureSpec.makeMeasureSpec(measuredWidth + addedWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
