            ...
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                ...
                if (clazz.isAssignableFrom(requestedType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.35.1
                        ...
                        /* JADX WARN: Multi-variable type inference failed */
                        /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, T1] */
                        @Override // com.google.gson.TypeAdapter
                        public T1 read(JsonReader in) throws IOException {
                            ?? read = typeAdapter.read(in);
                            if (read != 0 && !requestedType.isInstance(read)) {
                                throw new JsonSyntaxException("Expected a " + requestedType.getName() + " but was " + read.getClass().getName());
                            }
                            return read;
                        }
                    };
