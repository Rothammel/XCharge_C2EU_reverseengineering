...
public final class Decoder {
    ...
    private static final String[] UPPER_TABLE = {"CTRL_PS", StringUtils.SPACE, "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", UnitOfMeasure.K, "L", "M", Phase.N, "O", "P", "Q", "R", "S", "T", "U", UnitOfMeasure.V, "W", "X", "Y", "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    ...
    private static final String[] PUNCT_TABLE = {"", StringUtils.CR, HttpProxyConstants.CRLF, ". ", ", ", ": ", "!", "\"", MqttTopic.MULTI_LEVEL_WILDCARD, "$", "%", "&", "'", "(", ")", Marker.ANY_MARKER, "+", ",", "-", ".", MqttTopic.TOPIC_LEVEL_SEPARATOR, ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
