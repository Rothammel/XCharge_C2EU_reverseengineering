...
public class StatusNotificationRequest extends XMSZMessage {
    ...
    public void setPointStatusCode(byte pointStatusCode) {
    ...
    public void setConnectorPlugStatus(byte connectorPlugStatus) {
        this.connectorPlugStatus = connectorPlugStatus;
    }
    ...
    public void setPointErrorCode(byte pointErrorCode) {
    ...
    public byte[] bodyToBytes() throws Exception {
        byte[] bytes = {this.connectorId, this.pointStatusCode, this.connectorPlugStatus, this.pointErrorCode};
