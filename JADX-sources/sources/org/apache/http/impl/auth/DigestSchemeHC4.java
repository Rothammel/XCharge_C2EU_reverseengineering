...
public class DigestSchemeHC4 extends RFC2617SchemeHC4 {
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest request) throws AuthenticationException {
        ...
        try {
            ...
            if (qop == 2) {
                this.a2 = String.valueOf(method) + ':' + uri;
            } else if (qop == 1) {
                ...
                if (entity != null && !entity.isRepeatable()) {
                    ...
                    this.a2 = String.valueOf(method) + ':' + uri + ':' + encode(entityDigester.getDigest());
                }
            } else {
                this.a2 = String.valueOf(method) + ':' + uri;
            }
            ...
            for (int i = 0; i < params.size(); i++) {
                ...
                BasicHeaderValueFormatterHC4.INSTANCE.formatNameValuePair(buffer, (NameValuePair) basicNameValuePair, !noQuotes);
            }
    ...
    static String encode(byte[] binaryData) {
        ...
        for (int i = 0; i < n; i++) {
            int low = binaryData[i] & HeartBeatRequest.PORT_STATUS_FAULT;
