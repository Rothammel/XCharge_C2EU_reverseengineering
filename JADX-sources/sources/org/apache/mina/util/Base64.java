...
public class Base64 {
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
        ...
        while (i < numberTriplets) {
            ...
            byte val3 = (b3 & AnyoMessage.CMD_RESET_CHARGE) == 0 ? (byte) (b3 >> 6) : (byte) ((b3 >> 6) ^ 252);
        ...
        if (fewerThan24bits == 8) {
            ...
            byte k2 = (byte) (b12 & 3);
            byte val12 = (b12 & AnyoMessage.CMD_RESET_CHARGE) == 0 ? (byte) (b12 >> 2) : (byte) ((b12 >> 2) ^ 192);
            ...
            byte k3 = (byte) (b13 & 3);
            byte val13 = (b13 & AnyoMessage.CMD_RESET_CHARGE) == 0 ? (byte) (b13 >> 2) : (byte) ((b13 >> 2) ^ 192);
