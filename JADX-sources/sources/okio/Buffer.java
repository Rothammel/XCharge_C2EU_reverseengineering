...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public long readLong() {
        ...
        int limit = segment.limit;
        if (limit - pos8 < 8) {
            return ((readInt() & XMSZHead.ID_BROADCAST) << 32) | (readInt() & XMSZHead.ID_BROADCAST);
        }
        byte[] data = segment.data;
    ...
    */
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        byte b0 = getByte(0L);
        if ((b0 & AnyoMessage.CMD_RESET_CHARGE) == 0) {
            ...
            codePoint = b0 & HeartBeatRequest.PORT_STATUS_FAULT;
            byteCount = 3;
            min = 2048;
        } else if ((b0 & 248) == 240) {
            codePoint = b0 & 7;
