...
/* renamed from: it.sauronsoftware.ftp4j.listparsers.EPLFListParser */
public class EPLFListParser implements FTPListParser {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (s > 0) {
                    ...
                    } else if (f.equals(MqttTopic.TOPIC_LEVEL_SEPARATOR)) {
                        dir = true;
                    }
                }
            }
    ...
    public static void main(String[] args) throws Throwable {
        FTPFile[] f = new EPLFListParser().parse(new String[]{"+i8388621.29609,m824255902,/,\tdev", "+i8388621.44468,m839956783,r,s10376,\tRFCEPLF"});
        for (FTPFile println : f) {
