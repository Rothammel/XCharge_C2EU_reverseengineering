...
/* renamed from: it.sauronsoftware.ftp4j.listparsers.MLSDListParser */
public class MLSDListParser implements FTPListParser {
    ...
    public FTPFile[] parse(String[] lines) throws FTPListParseException {
        ...
        for (String parseLine : lines) {
            FTPFile file = parseLine(parseLine);
            if (file != null) {
                list.add(file);
            }
        }
    ...
    private FTPFile parseLine(String line) throws FTPListParseException {
        ...
        if (modifyString != null) {
            String modifyString2 = new StringBuffer().append(modifyString).append(" +0000").toString();
            try {
