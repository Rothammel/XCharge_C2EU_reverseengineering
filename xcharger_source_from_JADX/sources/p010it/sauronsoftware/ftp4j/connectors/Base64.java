...
/* renamed from: it.sauronsoftware.ftp4j.connectors.Base64 */
class Base64 {
    ...
    public static void encode(java.io.File r6, java.io.File r7, int r8) throws java.io.IOException {
        /*
            ...
            encode((java.io.InputStream) r1, (java.io.OutputStream) r3, (int) r8)     // Catch:{ all -> 0x0031 }
        ...
        L_0x0031:
            ...
            goto L_0x001b
        */
        throw new UnsupportedOperationException("Method not decompiled: p010it.sauronsoftware.ftp4j.connectors.Base64.encode(java.io.File, java.io.File, int):void");
    }
    ...
    public static void encode(java.io.File r6, java.io.File r7) throws java.io.IOException {
        /*
            ...
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ all -> 0x002e }
            r3.<init>(r7)     // Catch:{ all -> 0x002e }
            encode((java.io.InputStream) r1, (java.io.OutputStream) r3)     // Catch:{ all -> 0x0031 }
            if (r3 == 0) goto L_0x0014
            r3.close()     // Catch:{ Throwable -> 0x0026 }
        L_0x0014:
            if (r1 == 0) goto L_0x0019
        ...
        L_0x0031:
            ...
            goto L_0x001b
        */
        throw new UnsupportedOperationException("Method not decompiled: p010it.sauronsoftware.ftp4j.connectors.Base64.encode(java.io.File, java.io.File):void");
    }
    ...
    public static void decode(java.io.File r6, java.io.File r7) throws java.io.IOException {
        /*
            ...
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ all -> 0x002e }
            r3.<init>(r7)     // Catch:{ all -> 0x002e }
            decode((java.io.InputStream) r1, (java.io.OutputStream) r3)     // Catch:{ all -> 0x0031 }
            if (r3 == 0) goto L_0x0014
            r3.close()     // Catch:{ Throwable -> 0x0026 }
        L_0x0014:
            if (r1 == 0) goto L_0x0019
        ...
        L_0x0031:
            ...
            goto L_0x001b
        */
        throw new UnsupportedOperationException("Method not decompiled: p010it.sauronsoftware.ftp4j.connectors.Base64.decode(java.io.File, java.io.File):void");
    }
