...
public final class Headers {
    ...
    public String toString() {
        ...
        int size = size();
        for (int i = 0; i < size; i++) {
            result.append(name(i)).append(": ").append(value(i)).append(StringUtils.f146LF);
        }
    ...
    /* renamed from: of */
    public static Headers m39of(String... namesAndValues2) {
    ...
    /* renamed from: of */
    public static Headers m38of(Map<String, String> headers) {
        if (headers == null) {
