...
public final class MediaType {
    ...
    public static MediaType get(String string) {
        ...
        if (!typeSubtype.lookingAt()) {
            throw new IllegalArgumentException("No subtype found for: \"" + string + TokenParser.DQUOTE);
        }
        ...
        for (int s = typeSubtype.end(); s < string.length(); s = parameter.end()) {
            ...
            if (!parameter.lookingAt()) {
                throw new IllegalArgumentException("Parameter is not formatted correctly: \"" + string.substring(s) + "\" for: \"" + string + TokenParser.DQUOTE);
            }
            ...
            if (name != null && name.equalsIgnoreCase("charset")) {
                ...
                if (charset2 == null || charsetParameter.equalsIgnoreCase(charset2)) {
                    ...
                    throw new IllegalArgumentException("Multiple charsets defined: \"" + charset2 + "\" and: \"" + charsetParameter + "\" for: \"" + string + TokenParser.DQUOTE);
                }
            }
        }
