...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0039:
                ...
                goto L_0x002d
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.C04511.run():void");
        }
    };
    boolean closed;
    ...
    private final class Entry {
        ...
        Entry(String key2) {
            ...
            StringBuilder fileBuilder = new StringBuilder(key2).append(ClassUtils.PACKAGE_SEPARATOR_CHAR);
