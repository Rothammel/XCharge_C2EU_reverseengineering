...
public final class StatusLine {
    ...
    public String toString() {
        ...
        result.append(this.protocol == Protocol.HTTP_1_0 ? HttpProxyConstants.HTTP_1_0 : HttpProxyConstants.HTTP_1_1);
        result.append(TokenParser.f168SP).append(this.code);
        if (this.message != null) {
            result.append(TokenParser.f168SP).append(this.message);
        }
