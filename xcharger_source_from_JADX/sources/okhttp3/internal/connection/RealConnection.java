...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r16) throws java.io.IOException {
        /*
            r15 = this;
            okhttp3.Route r11 = r15.route
            ...
            okhttp3.HttpUrl r12 = r1.url()     // Catch:{ AssertionError -> 0x00bd }
            java.lang.String r12 = r12.host()     // Catch:{ AssertionError -> 0x00bd }
            okhttp3.HttpUrl r13 = r1.url()     // Catch:{ AssertionError -> 0x00bd }
            ...
            r6 = r0
            r0 = r16
            okhttp3.ConnectionSpec r3 = r0.configureSecureSocket(r6)     // Catch:{ AssertionError -> 0x00bd }
            boolean r11 = r3.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x00bd }
            if (r11 == 0) goto L_0x0046
            okhttp3.internal.platform.Platform r11 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x00bd }
            okhttp3.HttpUrl r12 = r1.url()     // Catch:{ AssertionError -> 0x00bd }
            java.lang.String r12 = r12.host()     // Catch:{ AssertionError -> 0x00bd }
        ...
        L_0x0046:
            ...
            okhttp3.Handshake r10 = okhttp3.Handshake.get(r8)     // Catch:{ AssertionError -> 0x00bd }
            ...
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00bd }
            java.lang.String r13 = okhttp3.CertificatePinner.pin(r2)     // Catch:{ AssertionError -> 0x00bd }
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00bd }
            ...
            java.lang.String r13 = "\n    subjectAltNames: "
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00bd }
            java.util.List r13 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r2)     // Catch:{ AssertionError -> 0x00bd }
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00bd }
        ...
        L_0x00bd:
            r4 = move-exception
            boolean r11 = okhttp3.internal.Util.isAndroidGetsocknameError(r4)     // Catch:{ all -> 0x00ca }
        ...
        L_0x00d9:
            throw r11
        L_0x00da:
            okhttp3.CertificatePinner r11 = r1.certificatePinner()     // Catch:{ AssertionError -> 0x00bd }
            okhttp3.HttpUrl r12 = r1.url()     // Catch:{ AssertionError -> 0x00bd }
            java.lang.String r12 = r12.host()     // Catch:{ AssertionError -> 0x00bd }
        ...
        L_0x00fb:
            ...
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ AssertionError -> 0x00bd }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ AssertionError -> 0x00bd }
            r15.source = r11     // Catch:{ AssertionError -> 0x00bd }
            java.net.Socket r11 = r15.socket     // Catch:{ AssertionError -> 0x00bd }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ AssertionError -> 0x00bd }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ AssertionError -> 0x00bd }
            r15.sink = r11     // Catch:{ AssertionError -> 0x00bd }
            r15.handshake = r10     // Catch:{ AssertionError -> 0x00bd }
            if (r5 == 0) goto L_0x0131
            okhttp3.Protocol r11 = okhttp3.Protocol.get(r5)     // Catch:{ AssertionError -> 0x00bd }
        L_0x011d:
        ...
        L_0x012f:
            ...
            goto L_0x00fb
        L_0x0131:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x00bd }
            goto L_0x011d
        L_0x0134:
    ...
    private Request createTunnel(int readTimeout, int writeTimeout, Request tunnelRequest, HttpUrl url) throws IOException {
        ...
        } while (!"close".equalsIgnoreCase(response.header(org.apache.http.HttpHeaders.CONNECTION)));
