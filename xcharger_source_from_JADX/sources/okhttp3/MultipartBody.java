...
public final class MultipartBody extends RequestBody {
    ...
    private static final byte[] COLONSPACE = {AnyoMessage.CMD_SET_TIMING_CHARGE, 32};
    ...
    static StringBuilder appendQuotedString(StringBuilder target, String key) {
        target.append(TokenParser.DQUOTE);
        int len = key.length();
        for (int i = 0; i < len; i++) {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String name, @Nullable String filename, RequestBody body2) {
            ...
            return create(Headers.m39of(HttpHeaders.CONTENT_DISPOSITION, disposition.toString()), body2);
        }
