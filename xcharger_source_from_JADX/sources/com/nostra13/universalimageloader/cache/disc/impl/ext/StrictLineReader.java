...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f37CR = 13;

    /* renamed from: LF */
    private static final byte f38LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f39in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        int result = this.f39in.read(this.buf, 0, this.buf.length);
        if (result == -1) {
