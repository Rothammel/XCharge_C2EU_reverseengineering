...
public final class ImageLoaderConfiguration {
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        C0219L.writeDebugLogs(builder.writeLogs);
    }
    ...
    public static class Builder {
        ...
        public Builder taskExecutor(Executor executor) {
            if (!(this.threadPoolSize == 3 && this.threadPriority == 4 && this.tasksProcessingType == DEFAULT_TASK_PROCESSING_TYPE)) {
                C0219L.m17w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
        ...
        public Builder memoryCacheSize(int memoryCacheSize2) {
            ...
            if (this.memoryCache != null) {
                C0219L.m17w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
            }
        ...
        public Builder diskCacheSize(int maxCacheSize) {
            ...
            if (this.diskCache != null) {
                C0219L.m17w(WARNING_OVERLAP_DISK_CACHE_PARAMS, new Object[0]);
            }
        ...
        public Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
            if (this.diskCache != null) {
                C0219L.m17w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR, new Object[0]);
            }
