...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        C0219L.m17w("Can't define system cache directory! '%s' will be used.", cacheDirPath);
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.mkdirs()) {
            C0219L.m17w("Unable to create external cache directory", new Object[0]);
            return null;
        }
        try {
            ...
            C0219L.m16i("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
            return appCacheDir;
        }
    }
