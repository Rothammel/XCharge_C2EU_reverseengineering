...
public class OSSUtils {
    ...
    public static void populateCopyObjectHeaders(CopyObjectRequest copyObjectRequest, Map<String, String> headers) {
        headers.put(OSSHeaders.COPY_OBJECT_SOURCE, MqttTopic.TOPIC_LEVEL_SEPARATOR + copyObjectRequest.getSourceBucketName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + HttpUtil.urlEncode(copyObjectRequest.getSourceKey(), "utf-8"));
