...
public class CRC64 implements Checksum {
    ...
    public void update(byte[] b, int off, int len) {
        ...
        int idx = off;
        while (len >= 8) {
            this.value = ((((((table[7][(int) ((this.value & 255) ^ ((long) (b[idx] & 255)))] ^ table[6][(int) (((this.value >>> 8) & 255) ^ ((long) (b[idx + 1] & 255)))]) ^ table[5][(int) (((this.value >>> 16) & 255) ^ ((long) (b[idx + 2] & 255)))]) ^ table[4][(int) (((this.value >>> 24) & 255) ^ ((long) (b[idx + 3] & 255)))]) ^ table[3][(int) (((this.value >>> 32) & 255) ^ ((long) (b[idx + 4] & 255)))]) ^ table[2][(int) (((this.value >>> 40) & 255) ^ ((long) (b[idx + 5] & 255)))]) ^ table[1][(int) (((this.value >>> 48) & 255) ^ ((long) (b[idx + 6] & 255)))]) ^ table[0][(int) ((this.value >>> 56) ^ ((long) (b[idx + 7] & 255)))];
            idx += 8;
            len -= 8;
        }
        while (len > 0) {
