...
public class InitDirective extends JsonBean<InitDirective> {
    ...
    private Long reserve_time = null;
    ...
    public void setReserve_time(Long reserve_time2) {
        this.reserve_time = reserve_time2;
    }
}
