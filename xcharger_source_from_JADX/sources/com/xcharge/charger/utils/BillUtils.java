...
public class BillUtils {
    public static double calcIntervalCost(ArrayList<HashMap<String, Object>> priceSections, ArrayList<HashMap<String, Object>> meterSections) {
        ...
        Iterator<HashMap<String, Object>> it = meterSections.iterator();
        while (it.hasNext()) {
            HashMap<String, Object> meterSection = it.next();
            ...
            double fee = ((Double) getPriceSection(meterSectionBegin, meterSectionEnd, priceSections).get("price")).doubleValue() * ((Double) meterSection.get("meter")).doubleValue();
    ...
    private static ArrayList<HashMap<String, Object>> normalizeMeterSections(ArrayList<HashMap<String, Object>> arrayList, ArrayList<HashMap<String, Object>> arrayList2) {
        return null;
    }
}
