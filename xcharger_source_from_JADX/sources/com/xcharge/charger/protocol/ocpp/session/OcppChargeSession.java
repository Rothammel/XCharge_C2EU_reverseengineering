...
public class OcppChargeSession extends JsonBean<OcppChargeSession> {
    ...
    public void setTxChargingProfiles(HashMap<String, ArrayList<ChargingProfile>> txChargingProfiles2) {
        this.txChargingProfiles = txChargingProfiles2;
    }
    ...
    public void setEvSuspendStatus(boolean evSuspendStatus2) {
        this.evSuspendStatus = evSuspendStatus2;
    }
    ...
    public void setStopTxnMeterValues(ArrayList<MeterValue> stopTxnMeterValues2) {
        this.stopTxnMeterValues = stopTxnMeterValues2;
    }
}
