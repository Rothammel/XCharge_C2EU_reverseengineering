...
public class DCAPAdapter {
    ...
    private static class DCAPAdapterSession extends JsonBean<DCAPAdapterSession> {
        ...
        public void setAnyoTimestamp(long anyoTimestamp2) {
            this.anyoTimestamp = anyoTimestamp2;
        }
    }

    public void init(Context context2) {
        this.context = context2;
        this.f79sn = HardwareStatusCacheProvider.getInstance().getSn();
    ...
    public void handleUnlockPortRequest(AnyoMessage request) {
        ...
        init.setDevice_id("sn/" + this.f79sn);
    ...
    public void handleStartChargeRequest(AnyoMessage request) {
        ...
        switch (chargePolicyKey) {
            case 1:
                ...
                UserTcValue = String.format("%2f", new Object[]{Double.valueOf(new BigDecimal(chargePolicyValue / 100).setScale(2, 4).doubleValue())});
                break;
            case 2:
    ...
    public void handleResetChargeRequest(AnyoMessage request) {
        ...
        } else if (finChargeByRemote(chargeId) == null) {
    ...
    public void handleSetConfirm(DCAPMessage confirm) {
        String peerSeq = String.valueOf(((CAPMessage) confirm.getData()).getOpt().getSeq());
    ...
    public void handleFinIndicate(DCAPMessage indicate) {
        ...
        if ("init".equals(opt.getOp())) {
            ...
            if (dcapAdapterSession == null) {
                ...
                if (FIN_MODE.refuse.equals(finMode) || FIN_MODE.busy.equals(finMode) || FIN_MODE.cancel.equals(finMode) || FIN_MODE.plugin_timeout.equals(finMode) || FIN_MODE.port_forbiden.equals(finMode) || FIN_MODE.no_feerate.equals(finMode) || FIN_MODE.car.equals(finMode)) {
                    anyoStatusCode = 19;
                }
    ...
    private DCAPMessage createRequest(String from, String op, CAPDirectiveOption opt, Object directive) {
        ...
        request.setTo("device:sn/" + this.f79sn);
        request.setType("cap");
    ...
    private DCAPMessage finChargeByRemote(String chargeId) {
        ...
        if (chargeBill != null) {
            ...
            if ((chargeBill.getStart_time() <= 0 || chargeBill.getStop_time() != 0) && (chargeBill.getStop_time() <= 0 || chargeBill.getFin_time() != 0)) {
                ...
                DCAPMessage request = createRequest("user:" + userType + MqttTopic.TOPIC_LEVEL_SEPARATOR + userCode, "fin", opt, fin);
