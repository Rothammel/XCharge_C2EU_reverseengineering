...
public class ReportChargeStoppedResponse extends AnyoMessage {
    ...
    public AnyoMessage bodyFromBytes(byte[] bytes) throws Exception {
        ...
        Log.e("ChargeStoppedResponse.bodyFromBytes", "body length must be 0 or 4 !!! body: " + FormatUtils.bytesToHexString(bytes));
