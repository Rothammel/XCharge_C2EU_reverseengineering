...
public class ResetChargeRequest extends AnyoMessage {
    ...
    public AnyoMessage bodyFromBytes(byte[] bytes) throws Exception {
        if (bytes.length != 5) {
            Log.e("ResetChargeRequest.bodyFromBytes", "body length must be 5 !!! body: " + FormatUtils.bytesToHexString(bytes));
