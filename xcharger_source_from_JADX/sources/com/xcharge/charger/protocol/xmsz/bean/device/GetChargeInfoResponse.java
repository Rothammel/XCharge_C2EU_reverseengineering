...
public class GetChargeInfoResponse extends XMSZMessage {
    ...
    public void setBattryPercent(byte battryPercent2) {
        this.battryPercent = battryPercent2;
    }
    ...
    public void setChargeTime(int chargeTime2) {
    ...
    public void setRemainChargeTime(int remainChargeTime2) {
        this.remainChargeTime = remainChargeTime2;
    }
    ...
    public void setTemperature(short temperature2) {
    ...
    public void setCurrentPower(int currentPower2) {
        this.currentPower = currentPower2;
    }
    ...
    public void setCurrentVoltage(int currentVoltage2) {
        this.currentVoltage = currentVoltage2;
    }
    ...
    public void setCurrentAvailable(int currentAvailable2) {
        this.currentAvailable = currentAvailable2;
    }
    ...
    public void setMaxVoltage(int maxVoltage2) {
        this.maxVoltage = maxVoltage2;
    }
    ...
    public void setMaxTemperature(short maxTemperature2) {
    ...
    public void setMeterValue(int meterValue2) {
