...
public class FieldConfigUtils {
    ...
    /* renamed from: $SWITCH_TABLE$com$xcharge$charger$protocol$monitor$bean$ErrorCodeMapping */
    private static /* synthetic */ int[] f110x5e20695;

    /* renamed from: $SWITCH_TABLE$com$xcharge$charger$protocol$monitor$bean$ErrorCodeMapping */
    static /* synthetic */ int[] m26x5e20695() {
        int[] iArr = f110x5e20695;
        if (iArr == null) {
            iArr = new int[ErrorCodeMapping.values().length];
            try {
    ...
    public static int getCode(ErrorCodeMapping codeMapping) {
        switch (m26x5e20695()[codeMapping.ordinal()]) {
            case 1:
                return 200;
            case 2:
                return -1;
