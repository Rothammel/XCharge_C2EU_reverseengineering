...
public class LogUtils {
    private static final String LOG_FILE_FULL_NAME = "/data/data/com.xcharge.charger/download/logs/charger_app.log";
    ...
    private static synchronized void writeLog(java.lang.String r9) {
        /*
            java.lang.Class<com.xcharge.charger.protocol.monitor.util.LogUtils> r6 = com.xcharge.charger.protocol.monitor.util.LogUtils.class
            monitor-enter(r6)
            r3 = 0
            java.io.File r1 = new java.io.File     // Catch:{ Exception -> 0x0071 }
            java.lang.String r5 = "/data/data/com.xcharge.charger/download/logs/charger_app.log"
        ...
        L_0x00b0:
            ...
            goto L_0x0046
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xcharge.charger.protocol.monitor.util.LogUtils.writeLog(java.lang.String):void");
    }
        ...
        synchronized (LogUtils.class) {
            ...
            try {
                if (logFile.length() >= SINGLE_FILE_MAX_SIZE) {
                    rotateFile(10);
                    logFile.renameTo(new File("/data/data/com.xcharge.charger/download/logs/charger_app.log.1"));
                }
            } catch (Exception e) {
    ...
    private static synchronized void rotateFile(int num) throws Exception {
        synchronized (LogUtils.class) {
            int prev = num - 1;
            if (prev > 0) {
                File prevFile = new File("/data/data/com.xcharge.charger/download/logs/charger_app.log." + prev);
                if (prevFile.exists()) {
                    prevFile.renameTo(new File("/data/data/com.xcharge.charger/download/logs/charger_app.log." + num));
                }
                rotateFile(prev);
            }
        }
