...
public class CAPDelayStarted extends JsonBean<CAPDelayStarted> {
    ...
    public long getDelay_start_time() {
        return this.delay_start_time;
    }

    public void setDelay_start_time(long delay_start_time2) {
        this.delay_start_time = delay_start_time2;
    }
