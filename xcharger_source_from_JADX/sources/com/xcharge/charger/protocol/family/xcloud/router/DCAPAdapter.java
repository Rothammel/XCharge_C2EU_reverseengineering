...
public class DCAPAdapter {
    ...
    /* renamed from: $SWITCH_TABLE$com$xcharge$charger$protocol$family$xcloud$type$EnumDeviceAction */
    private static /* synthetic */ int[] f88x7a267c02 = null;
    ...
    /* renamed from: $SWITCH_TABLE$com$xcharge$charger$protocol$family$xcloud$type$EnumDeviceAction */
    static /* synthetic */ int[] m23x7a267c02() {
        int[] iArr = f88x7a267c02;
        if (iArr == null) {
            iArr = new int[EnumDeviceAction.values().length];
            try {
    ...
    private static class DCAPAdapterSession extends JsonBean<DCAPAdapterSession> {
        ...
        public void setXcloudTimestamp(long xcloudTimestamp2) {
            this.xcloudTimestamp = xcloudTimestamp2;
        }
        ...
        public void setExpired(long expired2) {
    ...
    public void init(Context context2) {
        ...
        this.f89sn = HardwareStatusCacheProvider.getInstance().getSn();
    ...
    public void handleRequestStartCharge(XCloudMessage request) {
        ...
        init.setDevice_id("sn/" + this.f89sn);
        init.setPort(request.getPort());
        init.setUser_balance((long) requestStartCharge.getBalance());
    ...
    public void handleRequestAction(XCloudMessage request) {
        ...
        switch (m23x7a267c02()[action.ordinal()]) {
            case 1:
        ...
        XCloudProtocolAgent.getInstance().sendReportActionResult(request, EnumActionStatus.failed, new DeviceError(DeviceError.JSON_ERROR, "unsuported action", (Object) null));
    }
    ...
    public void handleRequestVerification(XCloudMessage request) {
        ...
        DCAPMessage queryRequest = createRequest("server:" + SystemSettingCacheProvider.getInstance().getChargePlatform().getPlatform(), "query", opt, query);
        DCAPProxy.getInstance().sendRequest(queryRequest);
        DCAPAdapterSession dcapAdapterSession = new DCAPAdapterSession((DCAPAdapterSession) null);
        dcapAdapterSession.xcloudMsg = request;
        dcapAdapterSession.xcloudTimestamp = System.currentTimeMillis();
        dcapAdapterSession.expired = (long) ((expired + 5) * 1000);
    ...
    public void handleRequestAutoStop(XCloudMessage request) {
        ...
        if (chargeStopCondition != null) {
            ...
            if (chargeStopCondition.getFee() != null) {
                ...
                userTcType = USER_TC_TYPE.power;
                userTcValue = String.valueOf(Double.valueOf(((double) chargeStopCondition.getPower().intValue()) * 1.0d));
            }
            ...
            if (chargeSession == null || !chargeId.equals(chargeSession.getCharge_id())) {
                ...
                XCloudProtocolAgent.getInstance().sendReportAutoStopResult(request, new DeviceError("ERROR", (String) null, (Object) null));
                return;
            }
            ...
            DCAPMessage conditionRequest = createRequest("user:" + userType + MqttTopic.TOPIC_LEVEL_SEPARATOR + chargeSession.getUser_code(), CAPMessage.DIRECTIVE_CONDITION, opt, condition);
    ...
    public void handleRequestUpdateStartTime(XCloudMessage request) {
        ...
        if (startTime == null) {
            ...
            start.setUser_tc_type(USER_TC_TYPE.auto);
            start.setUser_tc_value((String) null);
            DCAPMessage startRequest = createRequest("user:" + userType + MqttTopic.TOPIC_LEVEL_SEPARATOR + userCode, "start", opt, start);
            ...
            DCAPProxy.getInstance().sendRequest(createRequest("user:" + userType2 + MqttTopic.TOPIC_LEVEL_SEPARATOR + chargeSession.getUser_code(), "fin", opt2, fin));
        } else {
            ...
            DCAPMessage conditionRequest = createRequest("user:" + userType3 + MqttTopic.TOPIC_LEVEL_SEPARATOR + chargeSession.getUser_code(), CAPMessage.DIRECTIVE_CONDITION, opt3, condition);
            DCAPProxy.getInstance().sendRequest(conditionRequest);
            DCAPAdapterSession dcapAdapterSession2 = new DCAPAdapterSession((DCAPAdapterSession) null);
    ...
    public void handleRequestStopCharge(XCloudMessage request) {
        ...
        if (!TextUtils.isEmpty(port)) {
            ...
            } else if (DeviceError.USER_REMOTE.equals(stopCause.getCode())) {
                from = "user:" + userType + MqttTopic.TOPIC_LEVEL_SEPARATOR + userCode;
            }
    ...
    public void handleRequestEndCharge(XCloudMessage request) {
        finChargeByRemote(String.valueOf(((RequestEndCharge) request.getBody()).getBillId()));
    }
    ...
    public void handleFinIndicate(DCAPMessage indicate) {
        ...
        if ("init".equals(opt.getOp())) {
            if (indicate.getTo().startsWith("user:nfc." + NFC_CARD_TYPE.U3)) {
                XCloudProtocolAgent.getInstance().sendReportChargeCancelled((XCloudMessage) null, opt.getCharge_id(), deviceError);
                return;
            }
            ...
            if (dcapAdapterSession == null) {
                ...
                XCloudProtocolAgent.getInstance().sendReportChargeCancelled(dcapAdapterSession.xcloudMsg, (String) null, deviceError);
    ...
    public void handleQueryConfirm(DCAPMessage confirm) {
        ...
        String name = dcapAdapterSession.xcloudMsg.getMessageName();
        String op = cap.getOp();
        if ("ack".equals(op)) {
    ...
    public void handleSetConfirm(DCAPMessage confirm) {
        ...
        if ("ack".equals(op)) {
            if (XCloudMessage.RequestAction.equals(name)) {
                XCloudProtocolAgent.getInstance().sendReportActionResult(dcapAdapterSession.xcloudMsg, EnumActionStatus.success, (DeviceError) null);
            }
        } else if (CAPMessage.DIRECTIVE_NACK.equals(op) && XCloudMessage.RequestAction.equals(name)) {
            XCloudProtocolAgent.getInstance().sendReportActionResult(dcapAdapterSession.xcloudMsg, EnumActionStatus.failed, new DeviceError("ERROR", (String) null, (Object) null));
        }
    ...
    public void handleConditionConfirm(DCAPMessage confirm) {
        ...
        if ("ack".equals(op)) {
            ...
            if (ConditionDirective.CONDITION_USER_STOP.equals(conditionId)) {
                if (((ConditionDirective) requstCap.getData()).getUserTcType() == null) {
                    ...
                    if (chargeSession != null) {
                        ...
                        chargeSession.setChargeStopCondition((ChargeStopCondition) null);
                    }
                }
                XCloudProtocolAgent.getInstance().sendReportAutoStopResult(dcapAdapterSession.xcloudMsg, (DeviceError) null);
            } else {
            ...
            if (ConditionDirective.CONDITION_USER_STOP.equals(conditionId2)) {
                XCloudProtocolAgent.getInstance().sendReportAutoStopResult(dcapAdapterSession.xcloudMsg, new DeviceError("ERROR", (String) null, (Object) null));
            } else {
            ...
            while (it.hasNext()) {
                ...
                if (nowTimestamp - session.xcloudTimestamp > session.getExpired()) {
                    ...
                    if (XCloudMessage.RequestStartCharge.equals(name)) {
                        finRequest(FIN_MODE.timeout, (ErrorCode) null, session.dcapMsg);
                        XCloudProtocolAgent.getInstance().sendReportChargeCancelled(request, (String) null, new DeviceError(DeviceError.OTHER, (String) null, (Object) null));
                        return;
                    }
                    if (!XCloudMessage.RequestStopCharge.equals(name)) {
                        if (XCloudMessage.RequestAutoStop.equals(name)) {
                            ...
                            XCloudProtocolAgent.getInstance().sendReportActionResult(request, EnumActionStatus.failed, new DeviceError("ERROR", (String) null, (Object) null));
                        }
                    }
                    it.remove();
                }
    ...
    private DCAPMessage createRequest(String from, String op, CAPDirectiveOption opt, Object directive) {
        ...
        request.setTo("device:sn/" + this.f89sn);
        request.setType("cap");
    ...
    private void finChargeByRemote(String chargeId) {
        ...
        if (chargeBill != null) {
            ...
            DCAPProxy.getInstance().sendRequest(createRequest("user:" + userType + MqttTopic.TOPIC_LEVEL_SEPARATOR + userCode, "fin", opt, fin));
            return;
        }
    ...
    private void eventRefuseChargeRequest(String port, CHARGE_REFUSE_CAUSE cause, HashMap<String, Object> attach) {
        ...
        DCAPProxy.getInstance().sendRequest(createRequest("server:" + SystemSettingCacheProvider.getInstance().getChargePlatform().getPlatform(), "event", opt, event));
    }
