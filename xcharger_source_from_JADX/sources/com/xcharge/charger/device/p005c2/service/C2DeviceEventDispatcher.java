...
import com.xcharge.charger.device.p005c2.status.HardwareStatusHandler;
...
/* renamed from: com.xcharge.charger.device.c2.service.C2DeviceEventDispatcher */
public class C2DeviceEventDispatcher {
    ...
    public void dispatchEvent(Handler handler, String event) {
        try {
            ...
            if (NFCEventData.EVENT_TAG.equals(name)) {
                ...
                NFCEventData nfcEventData = (NFCEventData) new NFCEventData().fromJson(data);
                ...
                DeviceBasicInfoData deviceBasicInfoData = (DeviceBasicInfoData) new DeviceBasicInfoData().fromJson(json.getString(name));
                ...
                String msg = json.getJSONObject(EVENT_RADAR_CAKIBRATION).getString("msg");
                ...
                PortRuntimeData chargeEventData = (PortRuntimeData) new PortRuntimeData().fromJson(data2);
    ...
    public void handleNFCStatus(String port, NFC nfcStatus) {
        ...
        Message msg = this.hardwareStatusHandler.obtainMessage(HardwareStatusHandler.MSG_PORT_NFC_STATUS, nfcStatus.clone());
        msg.setData(data);
