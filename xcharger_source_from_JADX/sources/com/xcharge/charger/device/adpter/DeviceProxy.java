...
public class DeviceProxy {
    ...
    public void setSystemStatusBLN(String port, int status) {
        C2DeviceProxy.getInstance().setSystemStatusBLN(port, status, Color.parseColor(RemoteSettingCacheProvider.getInstance().getDefaultBLNColor()) & ViewCompat.MEASURED_SIZE_MASK);
    }
