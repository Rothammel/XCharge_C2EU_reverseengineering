...
public class SystemSettingCacheProvider {
    ...
    private SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
        public void onSharedPreferenceChanged(SharedPreferences preferences, String key) {
            if (SystemSettingCacheProvider.PATH.equals(key)) {
                ...
                SystemSettingCacheProvider.this.notifyChange(SystemSettingCacheProvider.this.getUriFor((String) null));
            }
        }
    };
    ...
    public synchronized SystemSetting loadSetting() {
        ...
        String systemSetting2 = this.preferences.getString(PATH, (String) null);
        if (!TextUtils.isEmpty(systemSetting2)) {
            systemSetting = (SystemSetting) new SystemSetting().fromJson(systemSetting2);
        } else {
    ...
    public synchronized SwipeCardPermission getPortSwipeCardPermission(String port) {
        SwipeCardPermission swipeCardPermission;
        ...
        if (portsSwipeCardPermission != null) {
            swipeCardPermission = portsSwipeCardPermission.get(port);
        } else {
            swipeCardPermission = null;
        }
        return swipeCardPermission;
    }
