...
/* renamed from: com.xcharge.charger.ui.c2.activity.test.TestChargeActivity */
public class TestChargeActivity extends BaseActivity {
    ...
    public static long delayMillis = 1500;
    /* access modifiers changed from: private */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0221R.layout.activity_test_charge);
    ...
    public void initView() {
        this.tv_content = (TextView) findViewById(C0221R.C0223id.tv_content);
        this.tv_state = (TextView) findViewById(C0221R.C0223id.tv_state);
        this.tv_bottom = (TextView) findViewById(C0221R.C0223id.tv_bottom);
        this.tv_error = (TextView) findViewById(C0221R.C0223id.tv_error);
        this.tv_wifi = (TextView) findViewById(C0221R.C0223id.tv_wifi);
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.test.TestChargeActivity$TestHandler */
    static class TestHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (this.weakReference.get() != null && ((TestChargeActivity) this.weakReference.get()).tv_content != null) {
                Log.d("TestHandler.msg.what", new StringBuilder(String.valueOf(msg.what)).toString());
                switch (msg.what) {
                    case 1:
                        ((TestChargeActivity) this.weakReference.get()).tv_state.setText("充电枪已插入");
                        return;
                    case 2:
                        ((TestChargeActivity) this.weakReference.get()).tv_state.setText("等待连接");
                        return;
                    case 3:
                        ((TestChargeActivity) this.weakReference.get()).tv_state.setText("未授权");
                        return;
                    case 4:
                        ((TestChargeActivity) this.weakReference.get()).tv_state.setText("开始充电");
                        C2DeviceProxy.getInstance().lockGun("1");
                        ChargeStatusCacheProvider.getInstance().updatePortLockStatus("1", LOCK_STATUS.lock);
                        return;
                    case 5:
                        ((TestChargeActivity) this.weakReference.get()).tv_state.setText("结束充电");
                        return;
                    case 6:
                        ((TestChargeActivity) this.weakReference.get()).tv_state.setText("充满");
                    ...
                    case 7:
                        try {
                            ...
                            if (!TextUtils.isEmpty(firewareVer) && !TextUtils.isEmpty(appVer)) {
                                buffer.append(UnitOfMeasure.f121V + firewareVer + "-" + appVer).append("<br>");
                            }
                            ...
                            ((TestChargeActivity) this.weakReference.get()).tv_content.setText(Html.fromHtml(String.valueOf(buffer.toString()) + currentStr + "<br>" + voltageStr + "<br>" + buffer4.toString() + "<br> 刷卡测试NFC，当有滴滴声音时表示测试成功"));
                            ((TestChargeActivity) this.weakReference.get()).tv_rader.setVisibility(0);
                            ((TestChargeActivity) this.weakReference.get()).tv_rader.setText(new StringBuilder().append(data.getRader()).toString());
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.test.TestChargeActivity$PortListener */
    class PortListener implements PortStatusListener {
        ...
        public void onPlugin(String port, PortStatus data) {
            TestChargeActivity.this.mTestHandler.obtainMessage(1, (Object) null).sendToTarget();
        }

        public void onPlugout(String port, PortStatus data) {
            TestChargeActivity.this.mTestHandler.obtainMessage(2, (Object) null).sendToTarget();
        }
