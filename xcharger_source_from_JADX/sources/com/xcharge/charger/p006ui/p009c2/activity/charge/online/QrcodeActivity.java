...
/* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.QrcodeActivity */
public class QrcodeActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0221R.layout.activity_qrcode);
    ...
    public void initView() {
        this.iv_qrcode = (ImageView) findViewById(C0221R.C0223id.iv_qrcode);
        this.ll_phase = (LinearLayout) findViewById(C0221R.C0223id.ll_phase);
        this.tv_phase = (TextView) findViewById(C0221R.C0223id.tv_phase);
        this.iv_phase = (ImageView) findViewById(C0221R.C0223id.iv_phase);
        this.tv_title = (TextView) findViewById(C0221R.C0223id.tv_title);
        this.tv_subhead = (TextView) findViewById(C0221R.C0223id.tv_subhead);
        this.tv_device_code = (TextView) findViewById(C0221R.C0223id.tv_device_code);
        this.tv_power_price = (TextView) findViewById(C0221R.C0223id.tv_power_price);
        this.tv_service_price = (TextView) findViewById(C0221R.C0223id.tv_service_price);
        if (CountrySettingCacheProvider.getInstance().isSetRTL()) {
            this.ll_phase.setLayoutDirection(1);
        } else {
            this.ll_phase.setLayoutDirection(0);
        }
        this.tv_phase.setText(getString(C0221R.string.home_phash_type, new Object[]{Integer.valueOf(ChargeStatusCacheProvider.getInstance().getAmpCapacity())}));
        ...
        if (!TextUtils.isEmpty(deviceCode)) {
            this.tv_device_code.setText(getString(C0221R.string.home_device_code, new Object[]{deviceCode}));
        }
        if (CHARGE_PLATFORM.anyo.equals(SystemSettingCacheProvider.getInstance().getChargePlatform())) {
            this.tv_power_price.setText(SystemSettingCacheProvider.getInstance().getPlatformCustomizedData().get("id"));
            ...
            this.tv_power_price.setText(getString(C0221R.string.home_cur_electrovalence, new Object[]{CountrySettingCacheProvider.getInstance().format(BaseActivity.TWODP, Double.valueOf(Price.getInstance().getPowerPrice() + Price.getInstance().getServicePrice())), CountrySettingCacheProvider.getInstance().getMoneyDisp()}));
            this.tv_service_price.setText(getString(C0221R.string.home_cur_service_charge, new Object[]{CountrySettingCacheProvider.getInstance().format(BaseActivity.TWODP, Double.valueOf(Price.getInstance().getServicePrice())), CountrySettingCacheProvider.getInstance().getMoneyDisp()}));
        } else {
            this.tv_power_price.setText(C0221R.string.home_no_feepolicy);
            this.tv_service_price.setText("");
        }
    }
    ...
    private void getPlatformScanHintTitle() {
        ...
        if (CHARGE_PLATFORM.anyo.equals(platform) || CHARGE_PLATFORM.xmsz.equals(platform) || CHARGE_PLATFORM.yzx.equals(platform) || CHARGE_PLATFORM.ecw.equals(platform) || CHARGE_PLATFORM.ocpp.equals(platform)) {
            this.tv_title.setText(C0221R.string.home_wechat_app_scan_text);
        } else {
            this.tv_title.setText(C0221R.string.home_wechat_scan_text);
        }
    }
    ...
    private void getPlatformScanHintDesc() {
        CHARGE_PLATFORM platform = SystemSettingCacheProvider.getInstance().getChargePlatform();
        if (CHARGE_PLATFORM.anyo.equals(platform) || CHARGE_PLATFORM.xmsz.equals(platform) || CHARGE_PLATFORM.yzx.equals(platform) || CHARGE_PLATFORM.ecw.equals(platform) || CHARGE_PLATFORM.ocpp.equals(platform)) {
            this.tv_subhead.setText(C0221R.string.home_wechat_app_operating_instructions);
        } else {
            this.tv_subhead.setText(C0221R.string.home_wechat_operating_instructions);
        }
    }
    ...
    public void updateQrcodeView() {
        ...
        if (portStatus == null || portStatus.getQrcodeContent() == null) {
            this.iv_qrcode.setImageBitmap((Bitmap) null);
            return;
        }
        this.iv_qrcode.setImageBitmap(Utils.createQRImage(portStatus.getQrcodeContent(), 253, 253));
    }

    /* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.QrcodeActivity$ScreenStatusReceiver */
    ...
    private void setScreenBrightness(int paramInt) {
        ...
        localLayoutParams.screenBrightness = ((float) paramInt) / 255.0f;
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.QrcodeActivity$QrcodeContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.QrcodeActivity$FeeRateContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.QrcodeActivity$HintContentObserver */
