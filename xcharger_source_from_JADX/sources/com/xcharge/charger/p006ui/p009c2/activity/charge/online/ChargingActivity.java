...
/* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.ChargingActivity */
public class ChargingActivity extends BaseActivity {
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    removeMessages(1);
                    ChargingActivity.this.updateBubbleView();
                    ChargingActivity.this.mHandler.sendEmptyMessageDelayed(1, 300);
                    return;
                case 3:
                    ChargingActivity.this.chargeStateChange();
                    if (ChargingActivity.this.showHintDialog == null) {
                        ChargingActivity.this.showHintDialog = LoadingDialog.createDialog(ChargingActivity.this, ChargingActivity.this.getString(C0221R.string.charge_pause_charge_hint, new Object[]{Integer.valueOf(ChargingActivity.this.waitStop)}));
                    } else {
                        ChargingActivity.this.showHintDialog.changeLoadingText(ChargingActivity.this.getString(C0221R.string.charge_pause_charge_hint, new Object[]{Long.valueOf(((long) ChargingActivity.this.waitStop) - ChargingActivity.this.curPauseTime)}));
                    }
                    if (!ChargingActivity.this.showHintDialog.isShowing()) {
                        ChargingActivity.this.showHintDialog.show();
                    }
                ...
                case 4:
                    ...
                    chargingActivity.curPauseTime = chargingActivity.curPauseTime + 1;
                    if (ChargingActivity.this.curPauseTime < ((long) ChargingActivity.this.waitStop)) {
                        if (ChargingActivity.this.showHintDialog != null) {
                            ChargingActivity.this.showHintDialog.changeLoadingText(ChargingActivity.this.getString(C0221R.string.charge_pause_charge_hint, new Object[]{Long.valueOf(((long) ChargingActivity.this.waitStop) - ChargingActivity.this.curPauseTime)}));
                        }
                        sendEmptyMessageDelayed(4, 1000);
                    ...
                    ChargingActivity.this.handChargeServiceStopUI();
                    return;
                default:
                    return;
            }
    ...
    protected Handler mTimerHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 2:
                    ChargingActivity.this.tv_timer.setText(Utils.fromatTotalTime((System.currentTimeMillis() - ChargingActivity.this.chargingTime) / 1000));
                    ChargingActivity.this.timerHandler.startTimer(1000, 2, (Object) null);
                    return;
                default:
                    return;
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0221R.layout.activity_charging);
    ...
    public void onResume() {
        super.onResume();
        Log.d("ChargingActivity", "onResume");
    }

    /* access modifiers changed from: protected */
    public void onPause() {
        super.onPause();
        Log.d("ChargingActivity", "onPause");
    }

    /* access modifiers changed from: protected */
    public void onStop() {
        super.onStop();
        Log.d("ChargingActivity", "onStop");
    }
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.charge.online.ChargingActivity$ChargeStatusContentObserver */
    public class ChargeStatusContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ChargingActivity.this.initView();
        }
    }
}
