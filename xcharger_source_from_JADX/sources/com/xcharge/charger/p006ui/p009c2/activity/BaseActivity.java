...
import com.xcharge.charger.p006ui.p009c2.activity.advert.IdleAdDialog;
import com.xcharge.charger.p006ui.p009c2.activity.advert.PullAdActivity;
import com.xcharge.charger.p006ui.p009c2.activity.advert.ScanAdActivity;
...
import com.xcharge.charger.p006ui.p009c2.activity.fault.CloudFaultDialog;
import com.xcharge.charger.p006ui.p009c2.activity.fault.EnableActivity;
import com.xcharge.charger.p006ui.p009c2.activity.fault.ExceptionFaultDialog;
import com.xcharge.charger.p006ui.p009c2.activity.fault.NetworkFaultDialog;
import com.xcharge.charger.p006ui.p009c2.activity.fault.OnlineParkBusyHintActivity;
import com.xcharge.charger.p006ui.p009c2.activity.fault.VerificationDialog;
...
import com.xcharge.charger.p006ui.p009c2.activity.upgrade.UpgradeActivity;
...
import com.xcharge.charger.p006ui.p009c2.activity.widget.ShowInfoDialog;
import com.xcharge.charger.p006ui.p009c2.activity.widget.SmallDialog;
...
/* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity */
public abstract class BaseActivity extends Activity {
    ...
    /* access modifiers changed from: private */
    public CtrlHandler handler = null;
            ...
            switch (msg.what) {
                ...
                case 4099:
                    if (BaseActivity.this.nfcLoadingDialog == null) {
                        BaseActivity.this.nfcLoadingDialog = LoadingDialog.createDialog(BaseActivity.this, BaseActivity.this.getString(C0221R.string.nfc_processing));
                    } else {
                        BaseActivity.this.nfcLoadingDialog.changeLoadingText(BaseActivity.this.getString(C0221R.string.nfc_processing));
                    }
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$CtrlMessageReceiver */
    private class CtrlMessageReceiver extends BroadcastReceiver {
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$CtrlHandler */
    private class CtrlHandler extends Handler {
        private CtrlHandler() {
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 4097:
                    BaseActivity.this.onUICtrlReceived((UICtrlMessage) JsonBean.getGsonBuilder().create().fromJson((String) msg.obj, UICtrlMessage.class));
                    break;
            }
    ...
    public void initStatus() {
        ...
        if (Variate.getInstance().isRadar() && (port = HardwareStatusCacheProvider.getInstance().getPort("1")) != null) {
            if (PARK_STATUS.idle.getStatus().equals(port.getParkStatus().getParkStatus().getStatus()) && Utils.getCurrentClassName(context).equals(OnlineParkBusyHintActivity.class.getName())) {
                Utils.skipNfcQrcode(context);
                finish();
            }
        }
        if (!ChargeStatusCacheProvider.getInstance().getPortSwitch("1") && (Utils.getCurrentClassName(context).equals(NFCChargeInitActivity.class.getName()) || Utils.getCurrentClassName(context).equals(QrcodeActivity.class.getName()))) {
        ...
        this.tv_rader = (TextView) findViewById(C0221R.C0223id.tv_rader);
        this.iv_nfc_reading = (ImageView) findViewById(C0221R.C0223id.iv_nfc_reading);
        this.iv_company = (ImageView) findViewById(C0221R.C0223id.iv_company);
    ...
    public void onUICtrlReceived(UICtrlMessage msg) {
        ...
        if (UIEventMessage.TYPE_UI_ACTIVITY.equals(type)) {
            ...
            longPress((String) data.get("keyText"));
        }
    }
    ...
    private void dismissAllDialog() {
        ...
        if (activity != null && activity.equals(Utils.getCurrentClassName(context))) {
            ...
            Variate.getInstance().setActivity((String) null);
        }
    ...
    private void init() {
        ...
        this.handler = new CtrlHandler(this, (CtrlHandler) null);
        this.messageReceiver = new CtrlMessageReceiver(this, (CtrlMessageReceiver) null);
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$LocaleLangContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$NetWorkContentObserver */
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (HardwareStatusCacheProvider.getInstance().getNetworkStatus().isConnected()) {
                if ((CHARGE_PLATFORM.xcharge.equals(platform) && PLATFORM_CUSTOMER.anyo_private.equals(customer)) || ((CHARGE_PLATFORM.anyo.equals(platform) && !PLATFORM_CUSTOMER.anyo_svw.equals(customer)) || CHARGE_PLATFORM.xmsz.equals(platform))) {
                    String activity = Variate.getInstance().getActivity();
                    new CloudContentObserver(BaseActivity.this.handler).onChange(selfChange, Uri.parse("content://com.xcharge.charger.data.provider.device/hardware/cloud/connection"));
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$CloudContentObserver */
    public class CloudContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            PLATFORM_CUSTOMER customer = SystemSettingCacheProvider.getInstance().getPlatformCustomer();
            if (ChargeStatusCacheProvider.getInstance().isCloudConnected()) {
                UIEventMessageProxy.getInstance().sendEvent(QrcodeActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, getClass().getName(), "resume", (HashMap) null);
                ...
                } else if (Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeInitActivity.class.getName())) {
            ...
            } else if (Utils.getCurrentClassName(BaseActivity.context).equals(QrcodeActivity.class.getName())) {
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$LockStatusContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$PortEnableContentObserver */
    public class PortEnableContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (!ChargeStatusCacheProvider.getInstance().getPortSwitch("1")) {
                if (Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeInitActivity.class.getName()) || Utils.getCurrentClassName(BaseActivity.context).equals(QrcodeActivity.class.getName())) {
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$RadarStatusContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$FaultStatusContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$NfcStatusContentObserver */
    public class NfcStatusContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (uri.getPath().contains("ports/1/nfc/")) {
                NFC nfcStatus = (NFC) new NFC().fromJson(uri.getLastPathSegment());
                if (nfcStatus.isArrived()) {
                    ...
                    if (200 == nfcStatus.getLatestError().getCode() && Utils.getCurrentClassName(BaseActivity.context).equals(TestChargeActivity.class.getName())) {
                        BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_test_normal));
                        return;
                    }
                ...
                if (newHandleStatus != oldHandleStatus) {
                    if (!newHandleStatus && oldHandleStatus) {
                        ...
                        switch (error.getCode()) {
                            case ErrorCode.EC_NFC_ERROR:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_error));
                                break;
                            case ErrorCode.EC_NFC_UNRECOGNIZED_CARD:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_invalid));
                                break;
                            case ErrorCode.EC_NFC_UNAVAILABLE_KEYSEED:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_invalid));
                                break;
                            case ErrorCode.EC_NFC_INVALID_MANAGE_CARD_DATA:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_invalid_manage_card_data));
                                break;
                            case ErrorCode.EC_NFC_SET_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_set_fail));
                                break;
                            case ErrorCode.EC_NFC_SIGN_ERROR:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_invalid));
                                break;
                            case ErrorCode.EC_NFC_BIND_CARD_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_bind_card_fail));
                                break;
                            case ErrorCode.EC_NFC_SET_REFUSE:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_system_busy_repeat));
                                break;
                            case ErrorCode.EC_NFC_CHARGE_REFUSE:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_system_busy_repeat));
                                break;
                            case ErrorCode.EC_NFC_SCAN_REFUSE:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_scan_refuse));
                                break;
                            case ErrorCode.EC_NFC_INVALID_PORT:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_invalid_port));
                                break;
                            case ErrorCode.EC_NFC_UNPAID_BILL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_unpaid_bill));
                                break;
                            case ErrorCode.EC_NFC_CARD_RESERVED:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_reserved));
                                break;
                            case ErrorCode.EC_NFC_CARD_RESERVE_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_init_fail));
                                break;
                            case ErrorCode.EC_NFC_CARD_RELEASE_FAIL:
                                if (!Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargingActivity.class.getName())) {
                                    BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_fail_repeat));
                                    break;
                                } else {
                                    BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_end_charge_failure));
                                    break;
                                }
                            case ErrorCode.EC_NFC_CARD_AUTH_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_auth_fail, new Object[]{nfcStatus.getLatestCardNo()}));
                                break;
                            case ErrorCode.EC_NFC_CARD_UNPAID_CONSUME_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_unpaid_consume_fail));
                                break;
                            case ErrorCode.EC_NFC_CARD_UNPAID_BALANCE_NOT_ENOUGH:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_unpaid_balance_not_enough));
                                break;
                            case ErrorCode.EC_NFC_CARD_CONSUME_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_consume_fail));
                                break;
                            case ErrorCode.EC_NFC_CARD_BALANCE_NOT_ENOUGH:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_balance_not_enough));
                                break;
                            case ErrorCode.EC_NFC_RECOVERY_SIGN_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_recovery_sign_fail));
                                break;
                            case ErrorCode.EC_NFC_REWRITED_BALANCE:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_invalid));
                                break;
                            case ErrorCode.EC_NFC_NOT_GROUP_MODE:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_group_mode));
                                break;
                            case ErrorCode.EC_NFC_NOT_PERSONAL_MODE:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_personal_mode));
                                break;
                            case ErrorCode.EC_NFC_UNAVAILABLE_CLOUD:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_unavailable_cloud));
                                break;
                            case ErrorCode.EC_NFC_NOT_PERMIT_SWIPE:
                                if ((BaseActivity.this.wakeupAdDialog == null || !BaseActivity.this.wakeupAdDialog.isShowing()) && !Utils.getCurrentClassName(BaseActivity.context).equals(ScanAdActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(PullAdActivity.class.getName())) {
                                    if ((BaseActivity.this.exceptionFaultDialog == null || !BaseActivity.this.exceptionFaultDialog.isShowing()) && (BaseActivity.this.networkFaultDialog == null || !BaseActivity.this.networkFaultDialog.isShowing())) {
                                        if (!Utils.getCurrentClassName(BaseActivity.context).equals(UpgradeActivity.class.getName())) {
                                            if (!Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeWaittingStartActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargingActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeFinActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeBalanceActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(WaittingStartChargeActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(ChargingActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(ChargeCompleteActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(ChargeDelayedActivity.class.getName()) && !Utils.getCurrentClassName(BaseActivity.context).equals(ChargeCostActivity.class.getName())) {
                                                if (!Utils.getCurrentClassName(BaseActivity.context).equals(NFCConfigPersnalCardActivity.class.getName())) {
                                                    BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_permit_swipe));
                                                    break;
                                                } else {
                                                    BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_permit_swipe_bind));
                                                    break;
                                                }
                                            } else {
                                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_permit_swipe_charge));
                                                break;
                                            }
                                        } else {
                                            BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_permit_swipe_upgrade));
                                            break;
                                        }
                                    } else {
                                        BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_invalid_port));
                                    ...
                                    BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_permit_swipe_advert));
                                    break;
                                }
                                break;
                            case ErrorCode.EC_NFC_READ_FAILED:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_read_failed));
                                break;
                            case ErrorCode.EC_NFC_NOT_INIT_CHARGE_CARD:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_not_init_charge_card));
                                break;
                            case ErrorCode.EC_NFC_INIT_FAIL:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_init_fail));
                                break;
                            case ErrorCode.EC_NFC_SWIPE_PROCESSING:
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_swipe_processing, new Object[]{nfcStatus.getLatestCardNo()}));
                                break;
                        }
                        ...
                        if (200 == error.getCode() && nfcStatus.getLatestOprType() != null) {
                            if (NFC_OPR_TYPE.set.equals(nfcStatus.getLatestOprType())) {
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_set));
                                ...
                                BaseActivity.showSmallDialog(BaseActivity.this.getString(C0221R.string.nfc_card_bind));
                            }
                        }
                    }
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$UpgradeContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$PayContentObserver */
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (chargeBill != null && portNfCStatus != null) {
                ...
                if (!(CHARGE_USER_TYPE.nfc + "." + NFC_CARD_TYPE.U2).equals(user_type) || !latestCardNo.equals(user_code)) {
                    if (!(CHARGE_USER_TYPE.nfc + "." + NFC_CARD_TYPE.U3).equals(user_type) || !billId.equals(Variate.getInstance().getChargeId())) {
                        if (!CHARGE_INIT_TYPE.nfc.equals(init_type) && billId.equals(Variate.getInstance().getChargeId()) && Utils.getCurrentClassName(BaseActivity.context).equals(ChargeCostActivity.class.getName())) {
                            BaseActivity.this.initView();
                        }
                    } else if (Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeBalanceActivity.class.getName())) {
                        BaseActivity.this.initView();
                    }
                } else if (Utils.getCurrentClassName(BaseActivity.context).equals(NFCChargeInitActivity.class.getName()) || Utils.getCurrentClassName(BaseActivity.context).equals(QrcodeActivity.class.getName())) {
                    BaseActivity.this.showErrorNfc(C0221R.string.nfc_card_unpaid_consume_ok_one, chargeBill);
                }
            }
        }
    }

    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$CompanyContentObserver */
    ...
    /* renamed from: com.xcharge.charger.ui.c2.activity.BaseActivity$PluginContentObserver */
    ...
    public void showErrorNfc(int resId, ChargeBill chargeBill) {
        ...
        String totalFee = CountrySettingCacheProvider.getInstance().format(TWODP, Double.valueOf(((double) chargeBill.getTotal_fee()) / 100.0d));
        String user_balance = CountrySettingCacheProvider.getInstance().format(TWODP, Double.valueOf(((double) chargeBill.getUser_balance()) / 100.0d));
        if (this.moneyLoadingDialog == null) {
        ...
        this.mRadarHandler.sendMessageDelayed(msg, 5000);
    }
    ...
    public void acquireScreenLock() {
        long timeout = ((long) RemoteSettingCacheProvider.getInstance().getChargeSetting().getTimerSetting().getIntervalStandby()) * 1000;
        this.handlerTimer.stopTimer(4098);
        holdScreenWl();
        this.handlerTimer.startTimer(timeout, 4098, (Object) null);
    }
    ...
    private void initScreenWakeLock() {
        this.screenWl = ((PowerManager) getSystemService(ChargeStopCondition.TYPE_POWER)).newWakeLock(268435466, getClass().getName());
