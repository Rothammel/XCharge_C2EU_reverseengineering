...
/* renamed from: com.xcharge.charger.ui.adpter.c2.update.UpdateChargeView */
public class UpdateChargeView {

    /* renamed from: $SWITCH_TABLE$com$xcharge$charger$ui$adapter$type$CHARGE_UI_STAGE */
    private static /* synthetic */ int[] f130xa4bfab5b;

    /* renamed from: $SWITCH_TABLE$com$xcharge$charger$ui$adapter$type$CHARGE_UI_STAGE */
    static /* synthetic */ int[] m36xa4bfab5b() {
        int[] iArr = f130xa4bfab5b;
        if (iArr == null) {
            iArr = new int[CHARGE_UI_STAGE.values().length];
            try {
    ...
    private void NfcChargeUiStage(CHARGE_UI_STAGE stage, Context context) {
        ...
        switch (m36xa4bfab5b()[stage.ordinal()]) {
            case 1:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcReady", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 3:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcScanAdvert", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 5:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcInited", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 7:
            ...
            case 8:
                ...
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcCharging", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 9:
                ...
                return;
            case 10:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcStopped", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case PortRuntimeData.STATUS_EX_11:
                BaseActivity.showSmallDialog(context.getString(C0297R.string.nfc_consume_succ));
                UICtrlMessageProxy.getInstance().sendCtrl(NFCChargeFinActivity.class.getName(), UIEventMessage.TYPE_UI_ELEMENT, UIEventMessage.SUBTYPE_UI_TEXT_VIEW, "mTvChargingTimer", "update", (HashMap) null);
                return;
            case PortRuntimeData.STATUS_EX_12:
                ...
                UICtrlMessageProxy.getInstance().sendCtrl(NFCChargeFinActivity.class.getName(), UIEventMessage.TYPE_UI_ELEMENT, (String) null, "initNFCChargeFin", "update", data);
                return;
            case 13:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcDelay", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 14:
                ...
                if (pullArrayList == null || !Utils.listIsEmpty(pullArrayList) || !Utils.fileIsEmpty(Utils.platformAdPath(ADVERT_POLICY.pullAdvsite.getPolicy())) || !Utils.fileNameIsEqual(pullArrayList)) {
                    UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcBilled", UICtrlMessage.OPR_SKIP, (HashMap) null);
                    return;
                }
                Log.i("pullAdvsite", RemoteSettingCacheProvider.getInstance().getRemoteSetting().getAdvertSetting().toJson());
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "nfcPullAdvsite", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 16:
                ...
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ELEMENT, (String) null, "errorStop", "update", data);
                return;
            default:
                return;
        }
    ...
    private void OnlineChargeUiStage(CHARGE_UI_STAGE stage, Context context) {
        ...
        switch (m36xa4bfab5b()[stage.ordinal()]) {
            case 1:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineReady", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 3:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineScanAdvert", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 4:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineUserReserved", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 5:
                Variate.getInstance().setPlugin(false);
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineInited", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 6:
                if (!Utils.getCurrentClassName(context).equals(WaittingStartChargeActivity.class.getName())) {
                    Variate.getInstance().setPlugin(true);
                    UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlinePlugin", UICtrlMessage.OPR_SKIP, (HashMap) null);
                    return;
                }
                data.put("pluginTime", new StringBuilder(String.valueOf(UIService.dataForWait.getInt("waitStart"))).toString());
                data.put("isGun", "yes");
                UICtrlMessageProxy.getInstance().sendCtrl(WaittingStartChargeActivity.class.getName(), UIEventMessage.TYPE_UI_ELEMENT, (String) null, "initWaittingStartCharge", "update", data);
                return;
            case 7:
                if (!UIService.dataForWait.containsKey("waitStart")) {
                    data.put("waitStart", "60");
            ...
            case 8:
                ...
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineCharging", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 9:
                if (!UIService.dataForWait.containsKey("waitStop")) {
                    data.put("waitStop", "30");
                ...
                return;
            case 10:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineStopped", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case PortRuntimeData.STATUS_EX_12:
                data.put("willDelayHandleNow", true);
                if (!UIService.dataForWait.containsKey("waitPlugout")) {
                ...
                UICtrlMessageProxy.getInstance().sendCtrl(ChargeCompleteActivity.class.getName(), UIEventMessage.TYPE_UI_ELEMENT, (String) null, "initChargeComplete", "update", data);
                return;
            case 13:
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineDelay", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 14:
                ArrayList<ContentItem> pullArrayList = RemoteSettingCacheProvider.getInstance().getAdvertContent(ADVERT_POLICY.pullAdvsite);
                if (pullArrayList == null || !Utils.listIsEmpty(pullArrayList) || !Utils.fileIsEmpty(Utils.platformAdPath(ADVERT_POLICY.pullAdvsite.getPolicy())) || !Utils.fileNameIsEqual(pullArrayList)) {
                    UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlineBilled", UICtrlMessage.OPR_SKIP, (HashMap) null);
                    return;
                }
                Log.i("pullAdvsite", RemoteSettingCacheProvider.getInstance().getRemoteSetting().getAdvertSetting().toJson());
                UICtrlMessageProxy.getInstance().sendCtrl(BaseActivity.class.getName(), UIEventMessage.TYPE_UI_ACTIVITY, (String) null, "onlinePullAdvsite", UICtrlMessage.OPR_SKIP, (HashMap) null);
                return;
            case 15:
    ...
    private void showErrorCause(String cause, Context context) {
        ...
        if (CHARGE_REFUSE_CAUSE.BAD_QRCODE.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_invalid_qrcode));
        } else if (CHARGE_REFUSE_CAUSE.USERGROUP_FORBIDDEN.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_usergroup_forbidden));
        } else if (CHARGE_REFUSE_CAUSE.BILL_UNPAID.getCause().equals(cause)) {
            String fee = null;
            if (causeData != null) {
                String billId = causeData.getString("bill_id");
                fee = causeData.getString(ChargeStopCondition.TYPE_FEE);
            }
            if (!TextUtils.isEmpty(fee)) {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_bill_unpaid_with_fee, new Object[]{CountrySettingCacheProvider.getInstance().format(BaseActivity.TWODP, Double.valueOf(((double) Integer.parseInt(fee)) / 100.0d)), CountrySettingCacheProvider.getInstance().getMoneyDisp()}));
                return;
            }
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_bill_unpaid));
        } else if (CHARGE_REFUSE_CAUSE.CHARGE_UNFINISHED.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_charge_unfinish));
        } else if (CHARGE_REFUSE_CAUSE.NOT_RESERVED.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_not_reserved));
        } else if (CHARGE_REFUSE_CAUSE.NOT_QUEUED.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_not_queued));
        } else if (CHARGE_REFUSE_CAUSE.RESERVE_UNDUE.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_reserved_undue));
            ...
            if (waitNum >= 0) {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_queued_undue, new Object[]{Integer.valueOf(waitNum)}));
                return;
            }
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_queued_undue));
        } else if (CHARGE_REFUSE_CAUSE.RESERVE_TIMEOUT.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_reserve_timeout));
        } else if (CHARGE_REFUSE_CAUSE.QUEUE_TIMEOUT.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_queued_timeout));
        } else if (CHARGE_REFUSE_CAUSE.BUSY.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_charge_busy));
        } else if (CHARGE_REFUSE_CAUSE.AUTH_TIMEOUT.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_auth_timeout));
        } else if (CHARGE_REFUSE_CAUSE.AUTH_REFUSE.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_auth_refuse));
        } else if (CHARGE_REFUSE_CAUSE.PORT_FORBIDEN.getCause().equals(cause)) {
            BaseActivity.showSmallDialog(context.getString(C0297R.string.error_port_forbiden));
        } else if (CHARGE_REFUSE_CAUSE.NO_FEERATE.getCause().equals(cause)) {
        } else {
            if (CHARGE_REFUSE_CAUSE.EXCEPT.getCause().equals(cause)) {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_pile_except));
            } else if (CHARGE_REFUSE_CAUSE.BALANCE_INSUFFICIENT.getCause().equals(cause)) {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_no_balance));
            } else if (CHARGE_REFUSE_CAUSE.BAD_IDCARD.getCause().equals(cause)) {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_bad_card));
            } else if (CHARGE_REFUSE_CAUSE.NOT_PLUGGED.getCause().equals(cause)) {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_not_plugged));
            } else {
                BaseActivity.showSmallDialog(context.getString(C0297R.string.error_unknown));
            }
        }
    }
    ...
    private void sendReservedTime() {
        ...
        UICtrlMessageProxy.getInstance().sendCtrl(ReservedActivity.class.getName(), UIEventMessage.TYPE_UI_ELEMENT, (String) null, "initReserved", "update", data);
    }
