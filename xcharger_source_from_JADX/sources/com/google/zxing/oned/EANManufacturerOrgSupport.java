...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{XCloudProtocolAgent.TIMER_MQTT_CONNECT_BLOCKED, 379}, "FR");
            add(new int[]{380}, "BG");
            add(new int[]{383}, "SI");
            add(new int[]{385}, "HR");
            add(new int[]{387}, "BA");
            add(new int[]{400, 440}, "DE");
            add(new int[]{FTPCodes.FILE_ACTION_NOT_TAKEN, 459}, "JP");
            ...
            add(new int[]{FTPCodes.SYNTAX_ERROR, 509}, "GB");
            add(new int[]{520}, "GR");
