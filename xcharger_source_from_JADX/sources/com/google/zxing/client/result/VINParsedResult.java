...
public final class VINParsedResult extends ParsedResult {
    ...
    public String getDisplayResult() {
        ...
        result.append(this.worldManufacturerID).append(TokenParser.f168SP);
        result.append(this.vehicleDescriptorSection).append(TokenParser.f168SP);
        result.append(this.vehicleIdentifierSection).append(10);
        if (this.countryCode != null) {
            result.append(this.countryCode).append(TokenParser.f168SP);
        }
        result.append(this.modelYear).append(TokenParser.f168SP);
        result.append(this.plantCode).append(TokenParser.f168SP);
