    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            if (!isInEditMode()) {
                ...
                if (widthMode == 0) {
                    widthSize = XCloudProtocolAgent.TIMER_MQTT_CONNECT_BLOCKED;
                }
            }
            ...
            if (!isInEditMode()) {
                ...
                heightSize = XCloudProtocolAgent.TIMER_MQTT_CONNECT_BLOCKED;
            }
        }
        int layoutHeight = 0;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp.width == -2) {
                    ...
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                } else {
                    childWidthSpec = View.MeasureSpec.makeMeasureSpec(lp.width, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                }
                if (lp.height == -2) {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, Integer.MIN_VALUE);
                } else if (lp.height == -1) {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                } else {
                    childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(lp.height, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                }
                ...
                if (child2.getVisibility() != 8) {
                    ...
                    if (child2.getVisibility() != 8) {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            if (lp2.weight > 0.0f) {
                                if (lp2.width != 0) {
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                                    ...
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                                } else {
                                    childHeightSpec = View.MeasureSpec.makeMeasureSpec(lp2.height, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                                }
                                if (canSlide) {
                                    int newWidth = widthAvailable - (lp2.leftMargin + lp2.rightMargin);
                                    int childWidthSpec2 = View.MeasureSpec.makeMeasureSpec(newWidth, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                                    if (measuredWidth != newWidth) {
                                        child2.measure(childWidthSpec2, childHeightSpec);
                                    }
                                } else {
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp2.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), childHeightSpec);
                                }
                            }
                        } else if (lp2.width < 0 && (measuredWidth > fixedPanelWidthLimit || lp2.weight > 0.0f)) {
                            if (!skippedFirstPass) {
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                            } else if (lp2.height == -2) {
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, Integer.MIN_VALUE);
                            } else if (lp2.height == -1) {
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                            } else {
                                childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(lp2.height, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE);
                            }
                            child2.measure(View.MeasureSpec.makeMeasureSpec(fixedPanelWidthLimit, NTLMConstants.FLAG_NEGOTIATE_KEY_EXCHANGE), childHeightSpec2);
                        }
                    }
                }
            }
