...
public class Base64 {
    ...
    static {
        ...
        byte[] bArr = new byte[FTPCodes.PATHNAME_CREATED];
    ...
    public static byte[] encode3to4(byte[] source, int srcOffset, int numSigBytes, byte[] destination, int destOffset, int options) {
        ...
        if (numSigBytes > 0) {
            i = (source[srcOffset] << AnyoMessage.CMD_REPORT_CHARGE_STOPPED) >>> 8;
        } else {
            i = 0;
        }
        int i3 = (numSigBytes > 1 ? (source[srcOffset + 1] << AnyoMessage.CMD_REPORT_CHARGE_STOPPED) >>> 16 : 0) | i;
        if (numSigBytes > 2) {
            i2 = (source[srcOffset + 2] << AnyoMessage.CMD_REPORT_CHARGE_STOPPED) >>> 24;
        }
        int inBuff = i3 | i2;
        switch (numSigBytes) {
            case 1:
    ...
    public static byte[] decode(String s, int options) throws IOException {
        ...
        if (bytes2 != null && bytes2.length >= 4 && !dontGunzip && 35615 == ((bytes2[0] & MotionEventCompat.ACTION_MASK) | ((bytes2[1] << 8) & 65280))) {
    ...
    public static class InputStream extends FilterInputStream {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:26:0x0065 A[LOOP:1: B:18:0x0041->B:26:0x0065, LOOP_END] */
        /* JADX WARNING: Removed duplicated region for block: B:47:0x0056 A[EDGE_INSN: B:47:0x0056->B:24:0x0056 ?: BREAK  , SYNTHETIC] */
        ...
        public int read() throws java.io.IOException {
            ...
            L_0x0022:
                ...
                int r5 = r11.options
                r4 = r1
                byte[] unused = org.java_websocket.util.Base64.encode3to4(r0, r1, r2, r3, r4, r5)
                r11.position = r1
                r11.numSigBytes = r10
            L_0x0030:
                int r3 = r11.position
            ...
            L_0x0056:
                ...
                byte[] r3 = r11.buffer
                int r4 = r11.options
                int r3 = org.java_websocket.util.Base64.decode4to3(r7, r1, r3, r1, r4)
                r11.numSigBytes = r3
                r11.position = r1
                goto L_0x0030
            L_0x0065:
            ...
            L_0x00a5:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.java_websocket.util.Base64.InputStream.read():int");
        }
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int theByte) throws IOException {
            if (this.suspendEncoding) {
                ...
                if (this.position >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f204b4, this.buffer, this.bufferLength, this.options));
                    this.lineLength += 4;
                ...
                if (this.position >= this.bufferLength) {
                    this.out.write(this.f204b4, 0, Base64.decode4to3(this.buffer, 0, this.f204b4, 0, this.options));
                    this.position = 0;
                }
            } else if (this.decodabet[theByte & TransportMediator.KEYCODE_MEDIA_PAUSE] != -5) {
        ...
        public void flushBase64() throws IOException {
            ...
            if (this.encode) {
                this.out.write(Base64.encode3to4(this.f204b4, this.buffer, this.position, this.options));
                this.position = 0;
                return;
            }
