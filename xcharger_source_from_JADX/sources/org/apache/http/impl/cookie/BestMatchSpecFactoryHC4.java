...
public class BestMatchSpecFactoryHC4 implements CookieSpecFactory, CookieSpecProvider {
    ...
    public BestMatchSpecFactoryHC4(String[] datepatterns2, boolean oneHeader2) {
    ...
    public CookieSpec newInstance(HttpParams params) {
        ...
        return new BestMatchSpecHC4(patterns, params.getBooleanParameter("http.protocol.single-cookie-header", false));
    }
