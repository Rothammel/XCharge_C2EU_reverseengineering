...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static int readULong(byte[] src, int index) throws NTLMEngineException {
        if (src.length >= index + 4) {
            return (src[index] & 255) | ((src[index + 1] & 255) << 8) | ((src[index + 2] & 255) << 16) | ((src[index + 3] & 255) << AnyoMessage.CMD_REPORT_CHARGE_STOPPED);
        }
    ...
    static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String domain, String host) throws NTLMEngineException {
            ...
            try {
                ...
                this.domainBytes = unqualifiedDomain != null ? unqualifiedDomain.toUpperCase(Locale.ENGLISH).getBytes(NTLMEngineImpl.DEFAULT_CHARSET) : bArr;
            } catch (UnsupportedEncodingException e) {
    ...
    static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String domain, String host, String user, String password, byte[] nonce, int type2Flags2, String target, byte[] targetInformation) throws NTLMEngineException {
            ...
            } else if ((1073741824 & type2Flags2) != 0) {
            ...
            if (unqualifiedHost != null) {
                try {
                    bArr = unqualifiedHost.getBytes("UnicodeLittleUnmarked");
    ...
    /* renamed from: F */
    static int m55F(int x, int y, int z) {
        return (x & y) | ((x ^ -1) & z);
    }

    /* renamed from: G */
    static int m56G(int x, int y, int z) {
        return (x & y) | (x & z) | (y & z);
    }

    /* renamed from: H */
    static int m57H(int x, int y, int z) {
        return (x ^ y) ^ z;
    }
    ...
    static class MD4 {
        ...
        /* renamed from: A */
        protected int f172A = 1732584193;

        /* renamed from: B */
        protected int f173B = -271733879;

        /* renamed from: C */
        protected int f174C = -1732584194;

        /* renamed from: D */
        protected int f175D = 271733878;
        ...
        public byte[] getOutput() {
            ...
            NTLMEngineImpl.writeULong(result, this.f172A, 0);
            NTLMEngineImpl.writeULong(result, this.f173B, 4);
            NTLMEngineImpl.writeULong(result, this.f174C, 8);
            NTLMEngineImpl.writeULong(result, this.f175D, 12);
            return result;
        }
        ...
        public void processBuffer() {
            int[] d = new int[16];
            for (int i = 0; i < 16; i++) {
                d[i] = (this.dataBuffer[i * 4] & 255) + ((this.dataBuffer[(i * 4) + 1] & 255) << 8) + ((this.dataBuffer[(i * 4) + 2] & 255) << 16) + ((this.dataBuffer[(i * 4) + 3] & 255) << AnyoMessage.CMD_REPORT_CHARGE_STOPPED);
            }
            int AA = this.f172A;
            int BB = this.f173B;
            int CC = this.f174C;
        ...
        public void round1(int[] d) {
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m55F(this.f173B, this.f174C, this.f175D) + d[0], 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m55F(this.f172A, this.f173B, this.f174C) + d[1], 7);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m55F(this.f175D, this.f172A, this.f173B) + d[2], 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m55F(this.f174C, this.f175D, this.f172A) + d[3], 19);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m55F(this.f173B, this.f174C, this.f175D) + d[4], 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m55F(this.f172A, this.f173B, this.f174C) + d[5], 7);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m55F(this.f175D, this.f172A, this.f173B) + d[6], 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m55F(this.f174C, this.f175D, this.f172A) + d[7], 19);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m55F(this.f173B, this.f174C, this.f175D) + d[8], 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m55F(this.f172A, this.f173B, this.f174C) + d[9], 7);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m55F(this.f175D, this.f172A, this.f173B) + d[10], 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m55F(this.f174C, this.f175D, this.f172A) + d[11], 19);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m55F(this.f173B, this.f174C, this.f175D) + d[12], 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m55F(this.f172A, this.f173B, this.f174C) + d[13], 7);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m55F(this.f175D, this.f172A, this.f173B) + d[14], 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m55F(this.f174C, this.f175D, this.f172A) + d[15], 19);
        }

        /* access modifiers changed from: protected */
        public void round2(int[] d) {
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m56G(this.f173B, this.f174C, this.f175D) + d[0] + 1518500249, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m56G(this.f172A, this.f173B, this.f174C) + d[4] + 1518500249, 5);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m56G(this.f175D, this.f172A, this.f173B) + d[8] + 1518500249, 9);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m56G(this.f174C, this.f175D, this.f172A) + d[12] + 1518500249, 13);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m56G(this.f173B, this.f174C, this.f175D) + d[1] + 1518500249, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m56G(this.f172A, this.f173B, this.f174C) + d[5] + 1518500249, 5);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m56G(this.f175D, this.f172A, this.f173B) + d[9] + 1518500249, 9);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m56G(this.f174C, this.f175D, this.f172A) + d[13] + 1518500249, 13);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m56G(this.f173B, this.f174C, this.f175D) + d[2] + 1518500249, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m56G(this.f172A, this.f173B, this.f174C) + d[6] + 1518500249, 5);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m56G(this.f175D, this.f172A, this.f173B) + d[10] + 1518500249, 9);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m56G(this.f174C, this.f175D, this.f172A) + d[14] + 1518500249, 13);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m56G(this.f173B, this.f174C, this.f175D) + d[3] + 1518500249, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m56G(this.f172A, this.f173B, this.f174C) + d[7] + 1518500249, 5);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m56G(this.f175D, this.f172A, this.f173B) + d[11] + 1518500249, 9);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m56G(this.f174C, this.f175D, this.f172A) + d[15] + 1518500249, 13);
        }

        /* access modifiers changed from: protected */
        public void round3(int[] d) {
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m57H(this.f173B, this.f174C, this.f175D) + d[0] + 1859775393, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m57H(this.f172A, this.f173B, this.f174C) + d[8] + 1859775393, 9);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m57H(this.f175D, this.f172A, this.f173B) + d[4] + 1859775393, 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m57H(this.f174C, this.f175D, this.f172A) + d[12] + 1859775393, 15);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m57H(this.f173B, this.f174C, this.f175D) + d[2] + 1859775393, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m57H(this.f172A, this.f173B, this.f174C) + d[10] + 1859775393, 9);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m57H(this.f175D, this.f172A, this.f173B) + d[6] + 1859775393, 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m57H(this.f174C, this.f175D, this.f172A) + d[14] + 1859775393, 15);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m57H(this.f173B, this.f174C, this.f175D) + d[1] + 1859775393, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m57H(this.f172A, this.f173B, this.f174C) + d[9] + 1859775393, 9);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m57H(this.f175D, this.f172A, this.f173B) + d[5] + 1859775393, 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m57H(this.f174C, this.f175D, this.f172A) + d[13] + 1859775393, 15);
            this.f172A = NTLMEngineImpl.rotintlft(this.f172A + NTLMEngineImpl.m57H(this.f173B, this.f174C, this.f175D) + d[3] + 1859775393, 3);
            this.f175D = NTLMEngineImpl.rotintlft(this.f175D + NTLMEngineImpl.m57H(this.f172A, this.f173B, this.f174C) + d[11] + 1859775393, 9);
            this.f174C = NTLMEngineImpl.rotintlft(this.f174C + NTLMEngineImpl.m57H(this.f175D, this.f172A, this.f173B) + d[7] + 1859775393, 11);
            this.f173B = NTLMEngineImpl.rotintlft(this.f173B + NTLMEngineImpl.m57H(this.f174C, this.f175D, this.f172A) + d[15] + 1859775393, 15);
        }
    }
