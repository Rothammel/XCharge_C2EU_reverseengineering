...
class MinimalHttpClient extends CloseableHttpClient {
    ...
    public MinimalHttpClient(HttpClientConnectionManager connManager2) {
        ...
        this.requestExecutor = new MinimalClientExec(new HttpRequestExecutor(), connManager2, DefaultConnectionReuseStrategyHC4.INSTANCE, DefaultConnectionKeepAliveStrategyHC4.INSTANCE);
    }
