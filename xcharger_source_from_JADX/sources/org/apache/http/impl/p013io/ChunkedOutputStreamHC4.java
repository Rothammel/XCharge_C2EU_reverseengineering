...
@NotThreadSafe
/* renamed from: org.apache.http.impl.io.ChunkedOutputStreamHC4 */
public class ChunkedOutputStreamHC4 extends OutputStream {
    ...
    @Deprecated
    public ChunkedOutputStreamHC4(SessionOutputBuffer out2, int bufferSize) throws IOException {
        this(bufferSize, out2);
    }

    @Deprecated
    public ChunkedOutputStreamHC4(SessionOutputBuffer out2) throws IOException {
        this(2048, out2);
    }

    public ChunkedOutputStreamHC4(int bufferSize, SessionOutputBuffer out2) {
