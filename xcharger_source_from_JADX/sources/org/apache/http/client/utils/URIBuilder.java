...
public class URIBuilder {
    ...
    private List<NameValuePair> parseQuery(String query2, Charset charset) {
        ...
        return URLEncodedUtilsHC4.parse(query2, charset);
    }
    ...
    private String encodeUserInfo(String userInfo2) {
        return URLEncodedUtilsHC4.encUserInfo(userInfo2, Consts.UTF_8);
    }

    private String encodePath(String path2) {
        return URLEncodedUtilsHC4.encPath(path2, Consts.UTF_8);
    }

    private String encodeUrlForm(List<NameValuePair> params) {
        return URLEncodedUtilsHC4.format((Iterable<? extends NameValuePair>) params, Consts.UTF_8);
    }

    private String encodeUric(String fragment2) {
        return URLEncodedUtilsHC4.encUric(fragment2, Consts.UTF_8);
    }
    ...
    public URIBuilder setUserInfo(String username, String password) {
        return setUserInfo(String.valueOf(username) + ':' + password);
    }
