...
public abstract class StrMatcher {
    ...
    private static final StrMatcher DOUBLE_QUOTE_MATCHER = new CharMatcher(TokenParser.DQUOTE);
    private static final StrMatcher NONE_MATCHER = new NoMatcher();
    private static final StrMatcher QUOTE_MATCHER = new CharSetMatcher("'\"".toCharArray());
    private static final StrMatcher SINGLE_QUOTE_MATCHER = new CharMatcher('\'');
    private static final StrMatcher SPACE_MATCHER = new CharMatcher(TokenParser.f168SP);
    ...
    static final class CharSetMatcher extends StrMatcher {
        ...
        CharSetMatcher(char[] chars2) {
            this.chars = (char[]) chars2.clone();
    ...
    static final class CharMatcher extends StrMatcher {
        ...
        public int isMatch(char[] buffer, int pos, int bufferStart, int bufferEnd) {
            return this.f149ch == buffer[pos] ? 1 : 0;
        }
    }
