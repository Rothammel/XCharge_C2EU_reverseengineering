...
public final class Range<T> implements Serializable {
    ...
    /* renamed from: is */
    public static <T extends Comparable<T>> Range<T> m47is(T element) {
        return between(element, element, (Comparator) null);
    }

    /* renamed from: is */
    public static <T> Range<T> m48is(T element, Comparator<T> comparator2) {
    ...
    public int hashCode() {
        ...
        int result2 = ((((getClass().hashCode() + 629) * 37) + this.minimum.hashCode()) * 37) + this.maximum.hashCode();
