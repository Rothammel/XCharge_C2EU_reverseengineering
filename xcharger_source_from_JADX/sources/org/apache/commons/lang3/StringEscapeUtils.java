...
public class StringEscapeUtils {
    ...
    public static final CharSequenceTranslator ESCAPE_JSON = new AggregateTranslator(new LookupTranslator(new String[]{"\"", "\\\""}, new String[]{"\\", "\\\\"}, new String[]{MqttTopic.TOPIC_LEVEL_SEPARATOR, "\\/"}), new LookupTranslator(EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), JavaUnicodeEscaper.outsideOf(32, TransportMediator.KEYCODE_MEDIA_PAUSE));
    @Deprecated
    ...
    static class CsvEscaper extends CharSequenceTranslator {
        ...
        private static final char[] CSV_SEARCH_CHARS = {CSV_DELIMITER, '\"', 13, 10};
