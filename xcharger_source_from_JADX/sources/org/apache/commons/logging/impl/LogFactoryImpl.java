...
public class LogFactoryImpl extends LogFactory {
    ...
    public Constructor getLogConstructor() throws LogConfigurationException {
        ...
        try {
            Class logClass = loadClass(logClassName2);
            if (logClass == null) {
                throw new LogConfigurationException(new StringBuffer().append("No suitable Log implementation for ").append(logClassName2).toString());
            }
            ...
            if (!cls.isAssignableFrom(logClass)) {
                throw new LogConfigurationException(new StringBuffer().append("Class ").append(logClassName2).append(" does not implement Log").toString());
            }
            try {
            ...
            try {
                ...
                throw new LogConfigurationException(new StringBuffer().append("No suitable Log constructor ").append(this.logConstructorSignature).append(" for ").append(logClassName2).toString(), t);
            }
        } catch (Throwable t2) {
