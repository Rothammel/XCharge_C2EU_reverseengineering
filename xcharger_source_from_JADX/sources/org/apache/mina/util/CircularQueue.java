...
public class CircularQueue<E> extends AbstractList<E> implements Queue<E>, Serializable {
    ...
    public CircularQueue(int initialCapacity2) {
        this.first = 0;
        this.last = 0;
        int actualCapacity = normalizeCapacity(initialCapacity2);
    ...
    private static int normalizeCapacity(int initialCapacity2) {
        int actualCapacity = 1;
        while (actualCapacity < initialCapacity2) {
            actualCapacity <<= 1;
            if (actualCapacity < 0) {
    ...
    public E get(int idx) {
        checkIndex(idx);
        return this.items[getRealIndex(idx)];
    }
