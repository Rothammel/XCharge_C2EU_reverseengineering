...
public class ProfilerTimerFilter extends IoFilterAdapter {
    ...
    public ProfilerTimerFilter(TimeUnit timeUnit2, IoEventType... eventTypes) {
    ...
    public void messageReceived(IoFilter.NextFilter nextFilter, IoSession session, Object message) throws Exception {
        if (this.profileMessageReceived) {
            ...
            this.messageReceivedTimerWorker.addNewDuration(timeNow() - start);
            return;
        }
        nextFilter.messageReceived(session, message);
    }
    ...
    public void messageSent(IoFilter.NextFilter nextFilter, IoSession session, WriteRequest writeRequest) throws Exception {
        if (this.profileMessageSent) {
            ...
            this.messageSentTimerWorker.addNewDuration(timeNow() - start);
            return;
        }
        nextFilter.messageSent(session, writeRequest);
    }
    ...
    public void sessionCreated(IoFilter.NextFilter nextFilter, IoSession session) throws Exception {
        if (this.profileSessionCreated) {
            ...
            this.sessionCreatedTimerWorker.addNewDuration(timeNow() - start);
            return;
        }
        nextFilter.sessionCreated(session);
    }
    ...
    public void sessionOpened(IoFilter.NextFilter nextFilter, IoSession session) throws Exception {
        if (this.profileSessionOpened) {
            ...
            this.sessionOpenedTimerWorker.addNewDuration(timeNow() - start);
            return;
        }
        nextFilter.sessionOpened(session);
    }
    ...
    public void sessionIdle(IoFilter.NextFilter nextFilter, IoSession session, IdleStatus status) throws Exception {
        if (this.profileSessionIdle) {
            ...
            this.sessionIdleTimerWorker.addNewDuration(timeNow() - start);
            return;
        }
        nextFilter.sessionIdle(session, status);
    }
    ...
    public void sessionClosed(IoFilter.NextFilter nextFilter, IoSession session) throws Exception {
        if (this.profileSessionClosed) {
            ...
            this.sessionClosedTimerWorker.addNewDuration(timeNow() - start);
            return;
        }
        nextFilter.sessionClosed(session);
    }
    ...
    private long timeNow() {
        switch (C05951.$SwitchMap$java$util$concurrent$TimeUnit[this.timeUnit.ordinal()]) {
            case 1:
