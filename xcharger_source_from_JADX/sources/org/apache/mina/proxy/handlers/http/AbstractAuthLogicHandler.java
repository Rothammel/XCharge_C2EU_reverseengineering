...
public abstract class AbstractAuthLogicHandler {
    ...
    protected AbstractAuthLogicHandler(ProxyIoSession proxyIoSession2) throws ProxyAuthException {
        ...
        this.request = proxyIoSession2.getRequest();
    ...
    public void writeRequest(IoFilter.NextFilter nextFilter, HttpProxyRequest request2) throws ProxyAuthException {
        logger.debug("  sending HTTP request");
        ((AbstractHttpLogicHandler) this.proxyIoSession.getHandler()).writeRequest(nextFilter, request2);
    }
