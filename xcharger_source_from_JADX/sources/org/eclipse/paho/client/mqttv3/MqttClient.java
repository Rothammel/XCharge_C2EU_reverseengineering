...
public class MqttClient implements IMqttClient {
    ...
    public void connect(MqttConnectOptions options) throws MqttSecurityException, MqttException {
        this.aClient.connect(options, (Object) null, (IMqttActionListener) null).waitForCompletion(getTimeToWait());
    }

    public IMqttToken connectWithResult(MqttConnectOptions options) throws MqttSecurityException, MqttException {
        IMqttToken tok = this.aClient.connect(options, (Object) null, (IMqttActionListener) null);
    ...
    public void disconnect(long quiesceTimeout) throws MqttException {
        this.aClient.disconnect(quiesceTimeout, (Object) null, (IMqttActionListener) null).waitForCompletion();
    }
