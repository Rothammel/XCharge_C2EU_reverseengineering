...
public class SSLSocketFactoryFactory {
    ...
    public String getSSLProtocol(String configID) {
        return getProperty(configID, SSLPROTOCOL, (String) null);
    }

    public String getJSSEProvider(String configID) {
        return getProperty(configID, JSSEPROVIDER, (String) null);
    }
    ...
    public String getKeyStoreProvider(String configID) {
        return getProperty(configID, KEYSTOREPROVIDER, (String) null);
    }
    ...
    public String getTrustStoreType(String configID) {
        return getProperty(configID, TRUSTSTORETYPE, (String) null);
    }

    public String getTrustStoreProvider(String configID) {
        return getProperty(configID, TRUSTSTOREPROVIDER, (String) null);
    }
    ...
    public String[] getEnabledCipherSuites(String configID) {
        return unpackCipherSuites(getProperty(configID, CIPHERSUITES, (String) null));
    }

    public boolean getClientAuthentication(String configID) {
        String auth = getProperty(configID, CLIENTAUTH, (String) null);
        if (auth != null) {
    ...
    private SSLContext getSSLContext(String configID) throws MqttSecurityException {
        ...
        String keyStoreName = getProperty(configID, KEYSTORE, (String) null);
        ...
        ctx.init(keyMgr, trustMgr, (SecureRandom) null);
        return ctx;
    }
    ...
    public SSLSocketFactory createSocketFactory(String configID) throws MqttSecurityException {
        ...
        if (this.logger != null) {
            ...
            Object[] objArr = new Object[2];
            objArr[0] = configID != null ? configID : "null (broker defaults)";
            objArr[1] = getEnabledCipherSuites(configID) != null ? getProperty(configID, CIPHERSUITES, (String) null) : "null (using platform-enabled cipher suites)";
