...
public class StringUtils {
    ...
    private static int ordinalIndexOf(CharSequence str, CharSequence searchStr, int ordinal, boolean lastIndex) {
        ...
        do {
            if (lastIndex) {
                ...
                index = CharSequenceUtils.indexOf(str, searchStr, searchStr.length() + index);
            }
            if (index >= 0) {
                found++;
            } else {
    ...
    public static String rightPad(String str, int size) {
        return rightPad(str, size, (char) TokenParser.SP);
    }
    ...
    public static String leftPad(String str, int size) {
        return leftPad(str, size, (char) TokenParser.SP);
    }
    ...
    public static String center(String str, int size) {
        return center(str, size, (char) TokenParser.SP);
    }
    ...
    public static double getJaroWinklerDistance(CharSequence first, CharSequence second) {
        ...
        double matchScore = Math.round((((0.1d * cl) * (1.0d - jaro)) + jaro) * 100.0d) / 100.0d;
        return matchScore;
    }
    ...
    private static double score(CharSequence first, CharSequence second) {
        ...
        return (((m1.length() / shorter.length()) + (m2.length() / longer.length())) + ((m1.length() - transpositions) / m1.length())) / 3.0d;
    }
