...
public class Args {
    ...
    public static <T extends CharSequence> T notEmpty(T argument, String name) {
        ...
        if (TextUtils.isEmpty(argument)) {
            throw new IllegalArgumentException(String.valueOf(name) + " may not be empty");
        }
        return argument;
    }
    ...
    public static <T extends CharSequence> T notBlank(T argument, String name) {
        ...
        if (TextUtils.isBlank(argument)) {
            throw new IllegalArgumentException(String.valueOf(name) + " may not be blank");
        }
        return argument;
    }
    ...
    public static int positive(int n, String name) {
        if (n <= 0) {
            throw new IllegalArgumentException(String.valueOf(name) + " may not be negative or zero");
        }
        return n;
    }
    ...
    public static int notNegative(int n, String name) {
        if (n < 0) {
            throw new IllegalArgumentException(String.valueOf(name) + " may not be negative");
        }
        return n;
    }
