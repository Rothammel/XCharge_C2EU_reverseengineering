...
public abstract class AuthSchemeBaseHC4 implements ContextAwareAuthScheme {
    ...
    public void processChallenge(Header header) throws MalformedChallengeException {
        ...
        if (authheader.equalsIgnoreCase(HttpHeaders.WWW_AUTHENTICATE)) {
            this.challengeState = ChallengeState.TARGET;
        } else if (authheader.equalsIgnoreCase(HttpHeaders.PROXY_AUTHENTICATE)) {
    ...
    public String toString() {
        ...
        return name != null ? name.toUpperCase(Locale.ENGLISH) : super.toString();
    }
}