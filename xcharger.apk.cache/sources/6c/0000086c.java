...
public class NFCChargeInitActivity extends BaseActivity {
    ...
    protected Handler mHandler = new Handler() { // from class: com.xcharge.charger.ui.c2.activity.charge.nfc.NFCChargeInitActivity.1
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfc_charge_init);
    ...
    protected void initView() {
        this.ll_jsm = (LinearLayout) findViewById(R.id.ll_jsm);
        this.ll_default = (LinearLayout) findViewById(R.id.ll_default);
        this.tv_price = (TextView) findViewById(R.id.tv_price);
        this.ll_phase = (LinearLayout) findViewById(R.id.ll_phase);
        this.tv_phash = (TextView) findViewById(R.id.tv_phash);
        ...
        if (Utils.getPricingStrategy(false)) {
            this.tv_price.setText(getString(R.string.home_cur_electrovalence, new Object[]{CountrySettingCacheProvider.getInstance().format(BaseActivity.TWODP, Double.valueOf(Price.getInstance().getPowerPrice() + Price.getInstance().getServicePrice())), CountrySettingCacheProvider.getInstance().getMoneyDisp()}));
        } else {
            this.tv_price.setText(R.string.home_no_feepolicy);
        }
        ...
        this.tv_phash.setText(getString(R.string.home_phash_type, new Object[]{Integer.valueOf(ChargeStatusCacheProvider.getInstance().getAmpCapacity())}));
