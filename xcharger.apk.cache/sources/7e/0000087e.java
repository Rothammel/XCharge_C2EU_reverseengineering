...
public class ChargingActivity extends BaseActivity {
    ...
    Handler mHandler = new Handler() { // from class: com.xcharge.charger.ui.c2.activity.charge.online.ChargingActivity.1
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    ChargingActivity.this.mHandler.sendEmptyMessageDelayed(1, 300L);
                    return;
                case 2:
                default:
                    return;
                case 3:
                    ...
                    if (ChargingActivity.this.showHintDialog == null) {
                        ChargingActivity.this.showHintDialog = LoadingDialog.createDialog(ChargingActivity.this, ChargingActivity.this.getString(R.string.charge_pause_charge_hint, new Object[]{Integer.valueOf(ChargingActivity.this.waitStop)}));
                    } else {
                        ChargingActivity.this.showHintDialog.changeLoadingText(ChargingActivity.this.getString(R.string.charge_pause_charge_hint, new Object[]{Long.valueOf(ChargingActivity.this.waitStop - ChargingActivity.this.curPauseTime)}));
                    }
                ...
                case 4:
                    removeMessages(4);
                    ChargingActivity.this.curPauseTime++;
                    if (ChargingActivity.this.curPauseTime < ChargingActivity.this.waitStop) {
                        if (ChargingActivity.this.showHintDialog != null) {
                            ChargingActivity.this.showHintDialog.changeLoadingText(ChargingActivity.this.getString(R.string.charge_pause_charge_hint, new Object[]{Long.valueOf(ChargingActivity.this.waitStop - ChargingActivity.this.curPauseTime)}));
                        }
                        sendEmptyMessageDelayed(4, 1000L);
    ...
    protected Handler mTimerHandler = new Handler() { // from class: com.xcharge.charger.ui.c2.activity.charge.online.ChargingActivity.2
        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 2:
                    long nowTime = (System.currentTimeMillis() - ChargingActivity.this.chargingTime) / 1000;
                    ChargingActivity.this.tv_timer.setText(Utils.fromatTotalTime(nowTime));
                    ChargingActivity.this.timerHandler.startTimer(1000L, 2, null);
                    return;
                default:
                    return;
            }
