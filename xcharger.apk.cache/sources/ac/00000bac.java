...
public class RequestBuilder {
    ...
    public HttpUriRequest build() {
        ...
        URI uri = this.uri != null ? this.uri : URI.create(MqttTopic.TOPIC_LEVEL_SEPARATOR);
        HttpEntity entity = this.entity;
        if (this.parameters != null && !this.parameters.isEmpty()) {
            if (entity == null && (HttpPostHC4.METHOD_NAME.equalsIgnoreCase(this.method) || "PUT".equalsIgnoreCase(this.method))) {
                entity = new UrlEncodedFormEntityHC4(this.parameters, Charset.forName(CharEncoding.ISO_8859_1));
            } else {
                try {
