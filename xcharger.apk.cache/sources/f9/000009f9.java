...
public final class CallServerInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (HttpMethod.permitsRequestBody(request.method()) && request.body() != null) {
            if ("100-continue".equalsIgnoreCase(request.header(org.apache.http.HttpHeaders.EXPECT))) {
        ...
        if ("close".equalsIgnoreCase(response.request().header(org.apache.http.HttpHeaders.CONNECTION)) || "close".equalsIgnoreCase(response.header(org.apache.http.HttpHeaders.CONNECTION))) {
            streamAllocation.noNewStreams();
        }
