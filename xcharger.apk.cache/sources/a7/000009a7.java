...
public final class Cookie {
    ...
    private static boolean pathMatch(HttpUrl url, String path) {
        ...
        return urlPath.startsWith(path) && (path.endsWith(MqttTopic.TOPIC_LEVEL_SEPARATOR) || urlPath.charAt(path.length()) == '/');
    }
    ...
    static Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        ...
        if (path == null || !path.startsWith(MqttTopic.TOPIC_LEVEL_SEPARATOR)) {
            ...
            path = lastSlash != 0 ? encodedPath.substring(0, lastSlash) : MqttTopic.TOPIC_LEVEL_SEPARATOR;
        }
    ...
    public int hashCode() {
        ...
        return (((((((((((((((hash * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32)))) * 31) + (this.secure ? 0 : 1)) * 31) + (this.httpOnly ? 0 : 1)) * 31) + (this.persistent ? 0 : 1)) * 31) + (this.hostOnly ? 0 : 1);
    }
}