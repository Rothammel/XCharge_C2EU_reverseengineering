...
public class ObjectMetadata {
    ...
    public String toString() {
        ...
        String s = "Last-Modified:" + getLastModified() + StringUtils.LF + "Expires:" + expirationTimeStr + StringUtils.LF + "rawExpires:" + getRawExpiresValue() + StringUtils.LF + "Content-MD5:" + getContentMD5() + StringUtils.LF + OSSHeaders.OSS_OBJECT_TYPE + ":" + getObjectType() + StringUtils.LF + OSSHeaders.OSS_SERVER_SIDE_ENCRYPTION + ":" + getServerSideEncryption() + StringUtils.LF + HttpHeaders.CONTENT_DISPOSITION + ":" + getContentDisposition() + StringUtils.LF + "Content-Encoding:" + getContentEncoding() + StringUtils.LF + "Cache-Control:" + getCacheControl() + StringUtils.LF + "ETag:" + getETag() + StringUtils.LF;
        return s;
    }
}