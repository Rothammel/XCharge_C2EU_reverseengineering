...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_MIXED_RAW = {AnyoMessage.CMD_SYNC_TIME, AnyoMessage.CMD_RESET_SYSTEM, 50, 51, 52, AnyoMessage.CMD_BIND_USER, AnyoMessage.CMD_QUERY_SYS_INFO, AnyoMessage.CMD_UPDATE_SYS_INFO, AnyoMessage.CMD_QUERY_FEE_POLICY, AnyoMessage.CMD_UPDATE_FEE_POLICY, 38, MqttWireMessage.MESSAGE_TYPE_PINGRESP, 9, 44, AnyoMessage.CMD_SET_TIMING_CHARGE, 35, 45, 46, 36, 47, 43, 37, 42, AnyoMessage.CMD_STOP_CHARGE, 94, 0, 32, 0, 0, 0};
    private static final byte[] TEXT_PUNCTUATION_RAW = {AnyoMessage.CMD_CANCEL_TIMING_CHARGE, AnyoMessage.CMD_START_CHARGE, AnyoMessage.CMD_START_UPGRADE, AnyoMessage.CMD_QUERY_CHARGE_SETTING, SocksProxyConstants.V4_REPLY_REQUEST_REJECTED_OR_FAILED, SocksProxyConstants.V4_REPLY_REQUEST_FAILED_NO_IDENTD, SocksProxyConstants.V4_REPLY_REQUEST_FAILED_ID_NOT_CONFIRMED, 95, 96, 126, AnyoMessage.CMD_REPORT_UPGRADE_DOWNLOAD_COMPLETE, MqttWireMessage.MESSAGE_TYPE_PINGRESP, 9, 44, AnyoMessage.CMD_SET_TIMING_CHARGE, 10, 45, 46, 36, 47, AnyoMessage.CMD_REPORT_NETWORK_INFO, 124, 42, 40, 41, 63, 123, 125, 39, 0};
