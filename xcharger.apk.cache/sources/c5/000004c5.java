        ...
        synchronized (this.in) {
            ...
            while (true) {
                if (i2 != this.end) {
                    ...
                    ByteArrayOutputStream out = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.nostra13.universalimageloader.cache.disc.impl.ext.StrictLineReader.1
