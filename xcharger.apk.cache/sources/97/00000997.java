        ...
        for (int i = 0; i < size; i++) {
            ...
            while (pos < value.length()) {
                ...
                if ("no-cache".equalsIgnoreCase(directive)) {
                    ...
                    maxAgeSeconds = okhttp3.internal.http.HttpHeaders.parseSeconds(parameter, -1);
                } else if ("s-maxage".equalsIgnoreCase(directive)) {
                    sMaxAgeSeconds = okhttp3.internal.http.HttpHeaders.parseSeconds(parameter, -1);
                    ...
                    maxStaleSeconds = okhttp3.internal.http.HttpHeaders.parseSeconds(parameter, Integer.MAX_VALUE);
                } else if ("min-fresh".equalsIgnoreCase(directive)) {
                    minFreshSeconds = okhttp3.internal.http.HttpHeaders.parseSeconds(parameter, -1);
