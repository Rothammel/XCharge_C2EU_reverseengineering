...
public class NetworkFaultDialog extends BaseDialog {
    ...
    public void initView() {
        ...
        this.iv_status_one.setImageResource(R.drawable.ic_net_work_error);
        ...
        if (CHARGE_PLATFORM.xcharge.equals(platform) && PLATFORM_CUSTOMER.anyo_private.equals(customer)) {
            this.tv_status_one.setText(R.string.anyo_private_network_error_status_text);
        } else {
            this.tv_status_one.setText(R.string.network_error_status_text);
        }
    }
