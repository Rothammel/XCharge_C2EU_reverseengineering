...
public class OcppCloudService extends Service {
    ...
    private IntlCloudServiceHandler handler = null;
    private IntlCloudServiceMsgReceiver receiver = null;

    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public class IntlCloudServiceMsgReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(DCAPMessage.ACTION_DCAP_CONFIRM)) {
                ...
                OcppCloudService.this.handler.sendMessage(OcppCloudService.this.handler.obtainMessage(65537, body));
            } else if (action.equals(DCAPMessage.ACTION_DCAP_INDICATE)) {
                String body2 = intent.getStringExtra("body");
                OcppCloudService.this.handler.sendMessage(OcppCloudService.this.handler.obtainMessage(65538, body2));
                ...
                OcppCloudService.this.handler.sendMessage(OcppCloudService.this.handler.obtainMessage(65552, port));
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public class IntlCloudServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            try {
                switch (msg.what) {
                    case 65537:
                        OcppCloudService.this.handleDCAPConfirm((String) msg.obj);
                        break;
                    case 65538:
                        OcppCloudService.this.handleDCAPIndicate((String) msg.obj);
                        break;
                    case 65552:
                        String port = (String) msg.obj;
                        Log.i("OcppCloudService.handleMessage", "receive qrcode update request for port: " + port);
                        OcppCloudService.this.handleQrcodeUpdateRequest(port);
                        break;
                }
            } catch (Exception e) {
                Log.e("OcppCloudService.handleMessage", "except: " + Log.getStackTraceString(e));
                LogUtils.syslog("OcppCloudService handleMessage exception: " + Log.getStackTraceString(e));
            }
    ...
    private void init() {
        ...
        this.handler = new IntlCloudServiceHandler(this, null);
        this.receiver = new IntlCloudServiceMsgReceiver(this, null);
    ...
    private boolean checkDCAPMessageRoute(DCAPMessage msg) {
        ...
        String to = msg.getTo();
        return from.startsWith("device:") && (!to.startsWith("server:") || to.startsWith(new StringBuilder("server:").append(CHARGE_PLATFORM.ocpp.getPlatform()).toString()));
    }
